...
$lang = array_merge($lang, array(
	...
	'MIGRATION_EXCEPTION_ERROR'			=> 'Κάτι πήγε στραβά κατά τη διάρκεια του επερωτήματος και μια εξαίρεση δεν έγινε. Οι αλλαγές που πραγματοποιήθηκαν πριν από το σφάλμα αντιστράφηκαν κατά το καλύτερο των δυνατοτήτων μας, αλλά θα πρέπει να ελέγξετε την Δ. Συζήτηση για λάθη.',
	...
	'MODULE_INFO_FILE_NOT_EXIST'		=> 'Ένα απαραίτητο αρχείο πληροφοριών για την μονάδα λείπει: %2$s',
