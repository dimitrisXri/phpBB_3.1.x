...
$lang = array_merge($lang, array(
	...
	'MIGRATION_INVALID_DATA_MISSING_CONDITION'		=> 'Μια μετεγκατάσταση είναι μη έγκυρη. Μια συνθήκη λείπει από μια βοηθητική δήλωση if.',
	'MIGRATION_INVALID_DATA_MISSING_STEP'			=> 'Μια μετεγκατάσταση είναι μη έγκυρη. Μια έγκυρη κλήση σε ένα βήμα της μετεγκατάστασης λείπει σε μια βοηθητική δήλωση if.',
	'MIGRATION_INVALID_DATA_CUSTOM_NOT_CALLABLE'	=> 'Μια μετεγκατάσταση είναι μη έγκυρη. Μια συνάρτηση προσαρμοσμένης κλήσης δεν μπορεί να κληθεί.',
	'MIGRATION_INVALID_DATA_UNKNOWN_TYPE'			=> 'Μια μετεγκατάσταση είναι μη έγκυρη. Ένας άγνωστος τύπος εργαλείου μετεγκατάστασης αντιμετωπίστηκε.',
	'MIGRATION_INVALID_DATA_UNDEFINED_TOOL'			=> 'Μια μετεγκατάσταση είναι μη έγκυρη. Ένα απροσδιόριστο εργαλείο μετεγκατάστασης έχει αντιμετωπιστεί.',
	'MIGRATION_INVALID_DATA_UNDEFINED_METHOD'		=> 'Μια μετεγκατάσταση είναι μη έγκυρη. Μια απροσδιόριστη μέθοδος ενός εργαλείου μετεγκατάστασης έχει αντιμετωπιστεί.',
