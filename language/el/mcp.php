...
$lang = array_merge($lang, array(
	...
	'APPROVE_POST_CONFIRM'	=> 'Είστε σίγουροι ότι θέλετε να εγκρίνετε αυτήν την δημοσίευση;',
	'APPROVE_POSTS'			=> 'Έγκριση δημοσιεύσεων,',
	'APPROVE_POSTS_CONFIRM'	=> 'Είστε σίγουροι ότι θέλετε να εγκρίνετε τις επιλεγμένες δημοσιεύσεις;',
	'APPROVE_TOPIC'			=> 'Έγκριση θέματος',
	'APPROVE_TOPIC_CONFIRM'	=> 'Είστε σίγουροι ότι θέλετε να εγκρίνετε αυτό το θέμα;',
	'APPROVE_TOPICS'		=> 'Έγκριση θεμάτων',
	'APPROVE_TOPICS_CONFIRM'=> 'Είστε σίγουροι ότι θέλετε να εγκρίνετε τα επιλεγμένα θέματα;',
	...
	'CLOSE_PM_REPORT_CONFIRM'	=> 'Είστε σίγουροι ότι θέλετε να κλείσετε την επιλεγμένη αναφορά ΠΜ;',
	'CLOSE_PM_REPORTS'		=> 'Κλείσιμο αναφορών ΠΜ',
	'CLOSE_PM_REPORTS_CONFIRM'	=> 'Είστε σίγουροι ότι θέλετε να κλείσετε τις επιλεγμένες αναφορές ΠΜ;',
	'CLOSE_REPORT'			=> 'Κλείσιμο αναφοράς',
	'CLOSE_REPORT_CONFIRM'	=> 'Είστε σίγουροι ότι θέλετε να κλείσετε την αναφορά για την επιλεγμένη δημοσίευση;',
	'CLOSE_REPORTS'			=> 'Κλείσιμο αναφορών',
	'CLOSE_REPORTS_CONFIRM'	=> 'Είστε σίγουροι ότι θέλετε να κλείσετε τις αναφορές για τις επιλεγμένες δημοσιεύσεις;',

	'DELETE_PM_REPORT'			=> 'Διαγραφή αναφοράς ΠΜ',
	'DELETE_PM_REPORT_CONFIRM'	=> 'Είστε σίγουροι ότι θέλετε να διαγράψετε την επιλεγμένη αναφορά ΠΜ;',
	'DELETE_PM_REPORTS'			=> 'Διαγραφή αναφορών ΠΜ',
	'DELETE_PM_REPORTS_CONFIRM'	=> 'Είστε σίγουροι ότι θέλετε να διαγράψετε τις επιλεγμένες αναφορές ΠΜ;',
	'DELETE_POSTS'				=> 'Διαγραφή δημοσιεύσεων',
	'DELETE_REPORT'				=> 'Διαγραφή αναφοράς',
	'DELETE_REPORT_CONFIRM'		=> 'Είστε σίγουροι ότι θέλετε να διαγράψετε την επιλεγμένη αναφορά;',
	'DELETE_REPORTS'			=> 'Διαγραφή αναφορών',
	'DELETE_REPORTS_CONFIRM'	=> 'Είστε σίγουροι ότι θέλετε να διαγράψετε τις επιλεγμένες αναφορές;',
	...
	'DISAPPROVE_POST_CONFIRM'	=> 'Είστε σίγουροι ότι θέλετε να απορρίψετε αυτήν την δημοσίευση;',
	'DISAPPROVE_POSTS'			=> 'Απόρριψη δημοσιεύσεων',
	'DISAPPROVE_POSTS_CONFIRM'	=> 'Είστε σίγουροι ότι θέλετε να απορρίψετε αυτές τις δημοσιεύσεις;',
	...
	'EMPTY_TOPICS_REMOVED_WARNING'	=> 'Παρακαλώ σημειώστε ότι ένα ή περισσότερα θέματα έχουν αφαιρεθεί από την βάσης δεδομένων σας, επειδή ήταν ή είναι κενά.',

	'FEEDBACK'				=> 'Ανατροφοδότηση',
	'FORK'					=> 'Αντιγραφή',
	'FORK_TOPIC'			=> 'Αντιγραφή δημοσίευσης',
	'FORK_TOPIC_CONFIRM'	=> 'Είστε σίγουροι ότι θέλετε να αντιγράψετε αυτήν την δημοσίευση;',
	'FORK_TOPICS'			=> 'Αντιγραφή επιλεγμένων θεμάτων',
	'FORK_TOPICS_CONFIRM'	=> 'Είστε σίγουροι ότι θέλετε να αντιγράψετε τα επιλεγμένα θέματα;',
	'FORUM_DESC'			=> 'Περιγραφή',
	'FORUM_NAME'			=> 'Όνομα Δ. Συζήτησης',
	'FORUM_NOT_EXIST'		=> 'Η Δ. Συζήτηση που επιλέξατε δεν υπάρχει',
	'FORUM_NOT_POSTABLE'	=> 'Στην Δ. Συζήτηση που επιλέξατε δεν μπορεί να δημοσιευθεί.',
	...
	'LOCK_POST_POST_CONFIRM'	=> 'Είστε σίγουροι ότι θέλετε να αποτρέψετε την επεξεργασία αυτής τη δημοσίευσης;',
	'LOCK_POST_POSTS'			=> 'Κλείδωμα επιλεγμένων δημοσιεύσεων',
	'LOCK_POST_POSTS_CONFIRM'	=> 'Είστε σίγουροι ότι θέλετε να αποτρέψετε την επεξεργασία των επιλεγμένων δημοσιεύσεων;',
	'LOCK_TOPIC_CONFIRM'		=> 'Είστε σίγουροι ότι θέλετε να κλειδώσετε αυτό το θέμα;',
	'LOCK_TOPICS'				=> 'Κλείδωμα επιλεγμένων θεμάτων',
	'LOCK_TOPICS_CONFIRM'		=> 'Είστε σίγουροι ότι θέλετε να κλειδώσετε όλα τα επιλεγμένα θέματα;',
	...
	'MCP_MAKE_ANNOUNCEMENT_CONFIRM'	=> 'Είστε σίγουροι ότι θέλετε να μετατρέψετε αυτό το θέμα σε “Ανακοίνωση”;',
	'MCP_MAKE_ANNOUNCEMENTS'		=> 'Μετατροπή σε “Ανακοινώσεις”',
	'MCP_MAKE_ANNOUNCEMENTS_CONFIRM'=> 'Είστε σίγουροι ότι θέλετε να μετατρέψετε τα επιλεγμένα θέματα σε “Ανακοινώσεις”;',
	'MCP_MAKE_GLOBAL'				=> 'Μετατροπή σε “Γενική ανακοίνωση”',
	'MCP_MAKE_GLOBAL_CONFIRM'		=> 'Είστε σίγουροι ότι θέλετε να μετατρέψετε αυτό το θέμα σε “Γενική ανακοίνωση”;',
	...
	'MCP_MAKE_STICKY_CONFIRM'		=> 'Είστε σίγουροι ότι θέλετε να μετατρέψετε αυτό το θέμα σε “Σημείωση”;',
	'MCP_MAKE_STICKIES'				=> 'Μετατροπή σε “Σημειώσεις”',
	'MCP_MAKE_STICKIES_CONFIRM'		=> 'Είστε σίγουροι ότι θέλετε να μετατρέψετε τα επιλεγμένα θέματα σε “Σημειώσεις”;',
	'MCP_MAKE_NORMAL'				=> 'Μετατροπή σε “Τυπικό Θέμα”',
	'MCP_MAKE_NORMAL_CONFIRM'		=> 'Είστε σίγουροι ότι θέλετε να μετατρέψετε αυτό το θέμα σε “Κανονικό θέμα”;',
	'MCP_MAKE_NORMALS'				=> 'Μετατροπή σε “Κανονικά Θέματα”',
	'MCP_MAKE_NORMALS_CONFIRM'		=> 'Είστε σίγουροι ότι θέλετε να μετατρέψετε τα επιλεγμένα θέματα σε “Κανονικά Θέματα”;',

	'MCP_NOTES'						=> 'Σημειώσεις μέλους',
	'MCP_NOTES_FRONT'				=> 'Κεντρική σελίδα',
	'MCP_NOTES_USER'				=> 'Λεπτομέρειες μέλους',

	'MCP_POST_REPORTS'				=> 'Αναφορές που εκδόθηκαν σε αυτήν την δημοσίευση',
	...
	'MCP_REPORTS_CLOSED'			=> 'Κλεισμένες αναφορές',
	...
	'MERGE_POSTS_CONFIRM'	=> 'Είστε σίγουροι ότι θέλετε να μετακινήσετε τις επιλεγμένες τις δημοσιεύσεις;',
	...
	'MERGE_TOPICS_CONFIRM'	=> 'Είστε σίγουροι ότι θέλετε να συγχωνεύσετε τα επιλεγμένα θέματα;',
	...
	'MOVE_TOPIC_CONFIRM'	=> 'Είστε σίγουροι ότι θέλετε να μετακινήσετε το θέμα σε μια νέα Δ. Συζήτηση;',
	'MOVE_TOPICS'			=> 'Μετακίνηση επιλεγμένων θεμάτων',
	'MOVE_TOPICS_CONFIRM'	=> 'Είστε σίγουροι ότι θέλετε να μετακινήσετε τα επιλεγμένα θέματα, σε μια νέα Δ. Συζήτηση;',
	...
	'NO_REASON_DISAPPROVAL'			=> 'Παρακαλώ δώστε ένα κατάλληλο λόγο για απόρριψη.',
	...
	'OTHER_USERS'			=> 'Άλλα μέλη τα οποία έχουν δημοσιεύσει από αυτή την διεύθυνση IP',
	...
	'PM_REPORTS_TOTAL'			=> array(
		0	=> 'Δεν υπάρχουν αναφορές ΠΜ προς εξέταση.',
		1	=> 'Συνολικά υπάρχει εδώ <strong>1</strong> αναφορά ΠΜ προς εξέταση.',
		2	=> ' Συνολικά υπάρχουν εδώ <strong>%d</strong> αναφορές ΠΜ προς εξέταση.',
	),
	...
	'POSTS_DELETED_SUCCESS'		=> 'Οι επιλεγμένες δημοσιεύσεις έχουν διαγραφεί με επιτυχία από την βάση δεδομένων.',
	...
	'POST_DELETED_SUCCESS'		=> 'Η επιλεγμένη δημοσίευση διαγράφτηκε με επιτυχία από την βάση δεδομένων.',
	...
	'REPORTS_TOTAL'				=> array(
		0	=> 'Δεν υπάρχουν αναφορές προς εξέτεαση.',
		1	=> 'Συνολικά υπάρχει εδώ <strong>1</strong> αναφορά προς εξέταση.',
		2	=> 'Συνολικά υπάρχουν εδώ <strong>%d</strong> αναφορές προς εξέταση.',
	),
	...
	'RESTORE_POST_CONFIRM'		=> 'Είστε σίγουροι ότι θέλετε να επαναφέρετε αυτήν την δημοσίευση;',
	'RESTORE_POSTS'				=> 'Επαναφορά δημοσιεύσεων',
	'RESTORE_POSTS_CONFIRM'		=> 'Είστε σίγουροι ότι θέλετε να επαναφέρετε τις επιλεγμένες δημοσιεύσεις;',
	'RESTORE_TOPIC'				=> 'Επαναφορά θέματος',
	'RESTORE_TOPIC_CONFIRM'		=> 'Είστε σίγουροι ότι θέλετε να επαναφέρετε αυτό το θέμα;',
	'RESTORE_TOPICS'			=> 'Επαναφορά θεμάτων',
	'RESTORE_TOPICS_CONFIRM'	=> 'Είστε σίγουροι ότι θέλετε να επαναφέρετε τα επιλεγμένα θέματα;',
	'RESYNC'					=> 'Συγχρονισμός ',
	...
	'SELECT_FORUM_GLOBAL_ANNOUNCEMENT'	=> 'Παρακαλώ επιλέξτε την Δ. Συζήτηση στην οποία θέλετε να εμφανίζεται αυτή η γενική ανακοίνωση.',
	'SELECT_FORUM_GLOBAL_ANNOUNCEMENTS'	=> 'Ένα ή περισσότερα από τα θέματα που επιλέξατε είναι γενικές ανακοινώσεις. Παρακαλώ επιλέξτε την Δ. Συζήτηση στην οποία θέλετε να εμφανίζονται.',
	...
	'SPLIT_TOPIC_ALL_CONFIRM'			=> 'Είστε σίγουροι ότι θέλετε να διαχωρίσετε αυτό το θέμα;',
	'SPLIT_TOPIC_BEYOND'				=> 'Διαχωρισμός θέματος σε επιλεγμένη δημοσίευση',
	'SPLIT_TOPIC_BEYOND_CONFIRM'		=> 'Είστε σίγουροι ότι θέλετε να διαχωρίσετε το επιλεγμένο θέμα σε αυτήν την δημοσίευση;',
	...
	'THIS_POST_IP'				=> 'Η διεύθυνση IP για αυτή την δημοσίευση',
	'TOPICS_APPROVED_SUCCESS'	=> 'Τα επιλεγμένα θέματα έχουν εγκριθεί.',
	'TOPICS_DELETED_SUCCESS'	=> 'Τα επιλεγμένα θέματα έχουν διαγραφεί με επιτυχία από την βάση δεδομένων.',
	...
	'TOPIC_DELETED_SUCCESS'		=> 'Το επιλεγμένο θέμα έχει διαγραφεί με επιτυχία από την βάση δεδομένων.',
	...
	'UNLOCK_POST_POST_CONFIRM'		=> 'Είστε σίγουροι ότι θέλετε να επιτρέψετε την επεξεργασία της δημοσίευσης;',
	'UNLOCK_POST_POSTS'				=> 'Ξεκλείδωμα επιλεγμένων δημοσιεύσεων',
	'UNLOCK_POST_POSTS_CONFIRM'		=> 'Είστε σίγουροι ότι θέλετε να επιτρέψετε την επεξεργασία των επιλεγμένων δημοσιεύσεων;',
	'UNLOCK_TOPIC'					=> 'Ξεκλείδωμα θέματος',
	'UNLOCK_TOPIC_CONFIRM'			=> 'Είστε σίγουροι ότι θέλετε να ξεκλειδώσετε αυτό το θέμα;',
	'UNLOCK_TOPICS'					=> 'Ξεκλείδωμα επιλεγμένων θεμάτων',
	'UNLOCK_TOPICS_CONFIRM'			=> 'Είστε σίγουροι ότι θέλετε να ξεκλειδώσετε όλα τα επιλεγμένα θέματα;',
	'USER_CANNOT_POST'				=> 'Δεν μπορείτε να δημοσιεύσετε σε αυτή την Δ. Συζήτηση.',
	'USER_CANNOT_REPORT'			=> 'Δεν μπορείτε να αναφέρετε δημοσιεύσεις σε αυτή την Δ. Συζήτηση.',
	...
	'WARNING_PM_SUBJECT'	=> 'Προειδοποίηση Δ. Συζήτησης εκδόθηκε',
