...
$lang = array_merge($lang, array(
	...
	'ACCOUNT_DEACTIVATED'			=> 'Ο λογαριασμός σας έχει απενεργοποιηθεί χειροκίνητα και μπορεί να επανενεργοποιηθεί μόνο από έναν διαχειριστή.',
	'ACCOUNT_NOT_ACTIVATED'			=> 'Ο λογαριασμός σας δεν έχει ενεργοποιηθεί ακόμη.',
	'ACP'							=> 'Πίνακας Ελέγχου Διαχειριστή',
	'ACP_SHORT'						=> 'ΠΕΔ',
	'ACTIVE'						=> 'ενεργό',
	'ACTIVE_ERROR'					=> 'Το συγκεκριμένο όνομα μέλους είναι προς το παρόν ανενεργό. Εάν αντιμετωπίζετε προβλήματα με την ενεργοποίηση του λογαριασμού σας, παρακαλώ επικοινωνήστε με κάποιον Διαχειριστή της Δ. Συζήτησης.',
	'ADMINISTRATOR'					=> 'Διαχειριστής',
	'ADMINISTRATORS'				=> 'Διαχειριστές',
	'AGE'							=> 'Ηλικία',
	'AIM'							=> 'AIM',
	'AJAX_ERROR_TITLE'				=> 'AJAX λάθος',
	'AJAX_ERROR_TEXT'				=> 'Κάτι πήγε στραβά κατά την επεξεργασία του αιτήματος σας.',
	'AJAX_ERROR_TEXT_ABORT'			=> 'Το αίτημα ακυρώθηκε από μέλος.',
	'AJAX_ERROR_TEXT_TIMEOUT'		=> 'Εξαντλήθηκε το χρονικό όριο του αιτήματος σας. Παρακαλώ προσπαθήστε εκ νέου.',
	'AJAX_ERROR_TEXT_PARSERERROR'	=> 'Κάτι πήγε στραβά με το αίτημα και ο διακομιστής επέστρεψε μια μη έγκυρη απάντηση.',
	'ALLOWED'						=> 'Επιτρέπεται',
	...
	'AUTH_PROVIDER_OAUTH_ERROR_INVALID_SERVICE_TYPE'		=> 'Άκυρος τύπος υπηρεσίας που παρέχεται στον χειριστή υπηρεσίας OAuth.',
	...
	'AVATAR_NO_SIZE'				=> 'Το πλάτος ή το ύψος του άβαταρ δεν μπορεί να καθοριστεί. Παρακαλώ εισάγετε το χειροκἰνητα.',
	...
	'AVATAR_REMOTE_UPLOAD_TIMEOUT'		=> 'Το καθορισμένο άβαταρ δεν ήταν δυνατόν να φορτωθεί επειδή εξαντλήθηκε το χρονικό όριο του επερωτἠματος.',
	...
	'BCC'					=> 'BCC',
	'BIRTHDAYS'				=> 'Γενέθλια',
	'BOARD_BAN_PERM'		=> 'Έχετε αποκλειστεί <strong>οριστικά</strong> από αυτήν την Δ. Συζήτηση.<br /><br />Παρακαλώ επικοινωνήστε με τον %2$sΔιαχειριστή της Δ. Συζήτησης%3$s για περισσότερες πληροφορίες.',
	'BOARD_BAN_REASON'		=> 'Λόγος που δόθηκε για αποκλεισμό: <strong>%s</strong>',
	'BOARD_BAN_TIME'		=> 'Έχετε αποκλειστεί από αυτήν την Δ. Συζήτηση μέχρι <strong>%1$s</strong>.<br /><br />Παρακαλώ επικοινωνήστε με τον %2$sΔιαχειριστή της Δ. Συζήτησης%3$s για περισσότερες πληροφορίες.',
	...
	'BOARD_UNAVAILABLE'		=> 'Συγγνώμη αλλά η Δ. Συζήτηση είναι προσωρινά μη διαθέσιμη, παρακαλώ προσπαθήστε πάλι σε μερικά λεπτά.',
	...
	'CONFIRM_OPERATION'		=> 'Είστε σίγουροι ότι επιθυμείτε να διενεργήσετε αυτήν την λειτουργία;',
	'CONFIRM_AVATAR_DELETE' => 'Είστε σίγουροι ότι θέλετε να διαγράψετε αυτό το άβαταρ;',
	...
	'COOKIES_DELETED'		=> 'Όλα τα cookies της Δ. Συζήτηση διαγράφηκαν με επιτυχία.',
	...
	'FROM'					=> 'από',
	'FSOCK_DISABLED'		=> 'Αυτή η λειτουργία δεν μπορεί να ολοκληρωθεί επειδή η <var>fsockopen</var> λειτουργία έχει απενεργοποιηθεί ή ο διακομιστής στον οποίο υποβλήθηκε το επερώτημα δεν μπορεί να βρεθεί.',
	'FSOCK_TIMEOUT'			=> 'Μια υπέρβαση χρονικού ορίου προέκυψε κατά την ανάγνωση από τη ροή του δικτύου',

	'FTP_FSOCK_HOST'				=> 'FTP κόμβος',
	'FTP_FSOCK_HOST_EXPLAIN'		=> 'Ο FTP διακομιστής που χρησιμοποιείται για να συνδεθείτε στην ιστοσελίδα σας.',
	...
	'FTP_FSOCK_ROOT_PATH_EXPLAIN'	=> 'Η διαδρομή του ριζικού φακέλου phpBB της Δ. Συζήτησή σας.',
	...
	'FTP_FSOCK_USERNAME_EXPLAIN'	=> 'Το όνομα χρήστη που χρησιμοποιείται για να συνδεθείτε στον διακομιστή σας.',

	'FTP_HOST'					=> 'FTP κόμβος',
	'FTP_HOST_EXPLAIN'			=> 'Ο FTP διακομιστής που χρησιμοποιείται για να συνδεθείτε στην ιστοσελίδα σας.',
	...
	'FTP_ROOT_PATH_EXPLAIN'		=> 'Η διαδρομή του ριζικού φακέλου phpBB της Δ. Συζήτησή σας.',
	'FTP_TIMEOUT'				=> 'FTP λήξη χρόνου αναμονής',
	...
	'IP'						=> 'IP',
	'IP_BLACKLISTED'			=> 'Η διεύθυνση IP σας %1$s έχει αποκλειστεί επειδή βρίσκεται στην μαύρη λίστα. Για περισσότερες λεπτομέρειες δείτε <a href="%2$s">%2$s</a>.',
	...
	'JUMP_TO_PAGE_CLICK'	=> 'Πατήστε για μετάβαση στην σελίδα…',
	...
	'LOCK_POST_EXPLAIN'					=> 'Αποτρέψετε επεξεργασία',
	...
	'LOGIN_CONFIRM_EXPLAIN'				=> 'Για την αποτροπή επιθέσεων ωμού εξαναγκασμού προς τον λογαριασμό σας η Δ. Συζήτηση απαιτεί από εσάς να εισάγετε έναν κωδικό επιβεβαίωσης μετά από έναν αριθμό αποτυχημένων προσπαθειών σύνδεσης. Ο κώδικας εμφανίζεται στην εικόνα που θα πρέπει να βλέπετε παρακάτω. Αν είστε άτομα με προβλήματα όρασης ή δεν μπορείτε να διαβάσετε διαφορετικά αυτόν τον κώδικα, παρακαλώ επικοινωνήστε με τον %sΔιαχειριστή της Δ. Συζήτησης%s.', // unused
	'LOGIN_ERROR_ATTEMPTS'				=> 'Έχετε υπερβεί το μέγιστο αριθμό προσπαθειών σύνδεσης. Εκτός από το όνομα μέλους και τον κωδικό πρόσβασης σας τώρα πρέπει επίσης επιλύσετε το CAPTCHA παρακάτω.',
	'LOGIN_ERROR_EXTERNAL_AUTH_APACHE'	=> 'Δεν έχετε εξουσιοδοτηθεί από τον Apache.',
	...
	'LOGIN_ERROR_PASSWORD_CONVERT'		=> 'Δεν ήταν δυνατή η μετατροπή του κωδικού πρόσβασης σας κατά την ενημέρωση του λογισμικού αυτής της Δ. Συζήτησης. Παρακαλώ %sζητήστε έναν νέο κωδικό%s. Εάν συνεχίσετε να έχετε προβλήματα επικοινωνήστε με τον %sΔιαχειριστή της Δ. Συζήτησης%s.',
	...
	'LOGIN_FORUM'						=> 'Για να προβάλετε ή να δημοσιεύσετε σε αυτή την Δ. Συζήτηση πρέπει να εισάγετε τον κωδικό της.',
	'LOGIN_INFO'						=> 'Προκειμένου να συνδεθείτε πρέπει να είστε εγγεγραμμένο μέλος. Η εγγραφή γίνεται σε λίγα μόνο λεπτά, αλλά σας παρέχει αυξημένες δυνατότητες. Οι διαχειριστές μπορεί επίσης να χορηγούν επιπρόσθετα δικαιώματα στα εγγεγραμμένα μέλη. Πριν συνδεθείτε, σιγουρευτείτε ότι γνωρίζετε τους όρους χρήσης και τις σχετικές πολιτικές. Παρακαλώ να διαβάσετε τους κανόνες της Δ. Συζήτησης κατά την πλοήγησή σας σε αυτήν την Δ. Συζήτηση.',
	'LOGIN_VIEWFORUM'					=> 'Η Δ. Συζήτηση απαιτεί ότι πρέπει να είστε εγγεγραμμένο μέλος και να έχετε συνδεθεί για να δείτε τις δημοσιεύσεις σε αυτή την Δ. Συζήτηση',
	'LOGIN_EXPLAIN_EDIT'				=> 'Προκειμένου να κάνετε επεξεργασία δημοσιεύσεων σε αυτή την Δ. Συζήτηση πρέπει να είστε εγγεγραμμένο μέλος και να έχετε συνδεθεί.',
	'LOGIN_EXPLAIN_VIEWONLINE'			=> 'Προκειμένου να δείτε την λίστα «ποιος είναι σε σύνδεση» πρέπει να είστε εγγεγραμμένο μέλος και να έχετε συνδεθεί.',
	'LOGIN_REQUIRED'					=> 'Πρέπει να συνδεθείτε για να κάνετε αυτήν την ενέργεια.',
	'LOGOUT'							=> 'Αποσύνδεση',
	...
	'MARK_SUBFORUMS_READ'	=> 'Επισήμανση υπό-συζητήσεων ως αναγνωσμένες',
	'MB'					=> 'MB',
	'MIB'					=> 'MiB',
	...
	'NOT_AUTHORISED'			=> 'Δεν είστε εξουσιοδοτημένοι για πρόσβαση σε αυτήν την περιοχή.',
	'NOT_WATCHING_FORUM'		=> 'Δεν είστε πλέον συνδρομητής για ενημερώσεις σε αυτήν την Δ. Συζήτηση.',
	...
	'NOTIFICATION_REPORT_PM'			=> '<strong>Αναφέρθηκε προσωπικό μήνυμα</strong> από %1$s:',
	'NOTIFICATION_REPORT_POST'			=> '<strong>Αναφέρθηκε δημοσίευση</strong> από %1$s:',
	'NOTIFICATION_REPORT_CLOSED'		=> '<strong>Αναφορά έκλεισε</strong> από %1$s για:',
	'NOTIFICATION_TOPIC'				=> '<strong>Νέο θέμα</strong> από %1$s:',
	'NOTIFICATION_TOPIC_APPROVED'		=> '<strong>Εγκρίθηκε θέμα</strong>:',
	...
	'NO_AUTH_ADMIN_USER_DIFFER'	=> 'Δεν μπορείτε να επαναλάβετε τον έλεγχο ταυτότητας ως ένα διαφορετικός μέλος.',
	'NO_AUTH_OPERATION'			=> 'Δεν έχετε τα απαραίτητα δικαιώματα για να ολοκληρώσετε αυτήν την λειτουργία.',
	...
	'NO_EMAIL_MESSAGE'			=> 'Το μήνυμα ηλεκτρονικού ταχυδρομείο ήταν κενό. κενό.',
	'NO_EMAIL_RESPONSE_CODE'	=> 'Δεν ήταν δυνατό να ληφθούν οι κώδικες απόκρισης του διακομιστή ηλεκτρονικής αλληλογραφίας.',
	...
	'NO_IPS_DEFINED'			=> 'Δεν προσδιορίστηκαν διευθύνσεις IP ή ονόματα διακομιστών',
	...
	'NO_SUPPORTED_AUTH_METHODS'	=> 'Δεν υπάρχουν υποστηριζόμενοι μέθοδοι εξουσιοδότησης.',
	'NO_TOPIC'					=> 'Το θέμα που ζητήθηκε δεν υπάρχει.',
	'NO_TOPIC_FORUM'			=> 'Το θέμα ή η Δ. Συζήτηση δεν υπάρχει πλέον.',
	'NO_TOPICS'					=> 'Δεν υπάρχουν θέματα ή δημοσιεύσεις σε αυτή την Δ. Συζήτηση.',
	'NO_TOPICS_TIME_FRAME'		=> 'Δεν υπάρχουν θέματα μέσα σε αυτήν την Δ. Συζήτηση για το επιλεγμένο χρονικό διάστημα.',
	...
	'POSTS_UNAPPROVED_FORUM'=> 'Τουλάχιστον μία δημοσίευση σε αυτήν την Δ. Συζήτηση δεν έχει εγκριθεί.',
	'POST_BY_AUTHOR'		=> 'από',
	'POST_BY_FOE'			=> '<strong>%1$s</strong>, που είναι προς το παρόν στην λίστα αγνόησης σας, έκανε αυτήν την δημοσίευση.',
	'POST_DISPLAY'			=> '%1$sΕμφάνιση αυτή της δημοσίευσης%2$s.',
	'POST_DAY'				=> '%.2f δημοσιεύσεις ανά ημέρα',
	'POST_DELETED_ACTION'	=> 'Διαγραμμένη δημοσίευση:',
	'POST_DELETED'			=> 'Αυτή η δημοσίευση διαγράφηκε.',
	'POST_DELETED_BY'		=> '<strong>%2$s</strong> διέγραψε την δημοσίευση από <strong>%1$s</strong> την %3$s.',
	'POST_DELETED_BY_REASON'=> '<strong>%2$s</strong> διέγραψε την δημοσίευση από <strong>%1$s</strong> την %3$s για τον παρακάτω λόγο: %4$s',
	...
	'REMOVE'					=> 'Διαγραφή',
	'REMOVE_INSTALL'			=> 'Παρακαλώ να διαγράψετε, να μετακινήσετε ή να μετονομάσετε το κατάλογο εγκατάστασης (install) πριν χρησιμοποιήσετε την Δ. Συζήτηση σας. Εάν αυτός ο κατάλογος εξακολουθεί να υπάρχει, μόνο ο Πίνακας Ελέγχου Διαχείρισης (ΠΕΔ) θα είναι προσβάσιμος.',
	'REPLIES'					=> 'Απαντήσεις',
	'REPLY_WITH_QUOTE'			=> 'Απάντηση με παράθεση',
	'REPLYING_GLOBAL_ANNOUNCE'	=> 'Απαντάει σε γενική ανακοίνωση',
	'REPLYING_MESSAGE'			=> 'Απαντάει στο μήνυμα σε %s',
	'REPORT_BY'					=> 'Αναφορά από',
	'REPORT_POST'				=> 'Αναφέρετε αυτήν την δημοσίευση',
	'REPORTING_POST'			=> 'Αναφέρει μία δημοσίευση',
	...
	'RETURN_INDEX'				=> '%sΕπιστροφή στην σελίδα ευρετηρίου%s',
	...
	'SEARCH_FORUM'				=> 'Αναζητήστε σε αυτή την Δ. Συζήτηση…',
	...
	'SKYPE'						=> 'Skype',
	'SMTP_NO_AUTH_SUPPORT'		=> 'Ο διακομιστής SMTP δεν υποστηρίζει εξουσιοδότηση.',
	'SORRY_AUTH_READ'			=> 'Δεν είστε εξουσιοδοτημένοι να αναγνώσετε αυτήν την Δ. Συζήτηση.',
	'SORRY_AUTH_VIEW_ATTACH'	=> 'Δεν είστε εξουσιοδοτημένοι να μεταφορτώσετε αυτό το συνημμένο.',
	...
	'SQL_ERROR_OCCURRED'		=> 'Ένα λάθος στην βάση δεδομένων παρουσιάστηκε κατά την ανάκτηση αυτής της σελίδας. Παρακαλώ ενημερώστε τον %sΔιαχειριστή της Δ. Συζήτησης%s εάν το πρόβλημα εξακολουθεί να υφίσταται.',
	...
	'TIB'				=> 'TiB',
	'TIME'				=> 'Ώρα',
	'TIMEOUT_PROCESSING_REQ'			=> 'Λήξη χρόνου επερωτήματος.',
	...
	'TOPIC'				=> 'Θέμα',
	'TOPICS'			=> 'Θέματα',
	'TOPICS_UNAPPROVED'	=> 'Τουλάχιστον ένα θέμα σε αυτήν την Δ. Συζήτηση δεν έχει εγκριθεί.',
	...
	'UNWATCH_FORUM_CONFIRM'		=> 'Είστε σίγουροι ότι επιθυμείτε να διακόψετε την συνδρομή από αυτήν την Δ. Συζήτηση;',
	'UNWATCH_FORUM_DETAILED'	=> 'Είστε σίγουροι ότι επιθυμείτε να διακόψετε την συνδρομή από την Δ. Συζήτηση “%s”;',
	'UNWATCH_TOPIC_CONFIRM'		=> 'Είστε σίγουροι ότι επιθυμείτε να διακόψετε την συνδρομή από αυτό το θέμα;',
	'UNWATCH_TOPIC_DETAILED'	=> 'Είστε σίγουροι ότι επιθυμείτε να διακόψετε την συνδρομή από το θέμα “%s”;',
	...
	'URL_REDIRECT'			=> 'Εάν το πρόγραμμα περιήγησης σας δεν υποστηρίζει ανακατεύθυνση meta %sπαρακαλώ πατήστε ΕΔΩ για να μεταφερθείτε%s.',
	'USERGROUPS'			=> 'Ομάδες',
	'USERNAME'				=> 'Όνομα μέλους',
	'USERNAMES'				=> 'Ονόματα μελών',
	'USER_AVATAR'			=> 'Άβαταρ μέλους',
	'USER_CANNOT_READ'		=> 'Δεν μπορείτε να αναγνώσετε δημοσιεύσεις σε αυτή την Δ. Συζήτηση',
	'USER_POSTS'			=> array(
		1	=> '%d Δημοσίευση',
		2	=> '%d Δημοσιεύσεις',
	),
	...
	'VIEWING_CONTACT_ADMIN'		=> 'Βλέπει σελίδα επικοινωνίας',
	'VIEWING_FAQ'				=> 'Βλέπει Συχνές ερωτήσεις',
	'VIEWING_MEMBERS'			=> 'Βλέπει λεπτομέρειες μέλους',
	'VIEWING_ONLINE'			=> 'Βλέπει μέλη σε σύνδεση',
	'VIEWING_MCP'				=> 'Βλέπει πίνακα ελέγχου συντονιστή',
	'VIEWING_MEMBER_PROFILE'	=> 'Βλέπει προφίλ μέλους',
	'VIEWING_PRIVATE_MESSAGES'	=> 'Βλέπει προσωπικά μηνύματα',
	'VIEWING_REGISTER'			=> 'Δημιουργεί λογαριασμό',
	'VIEWING_UCP'				=> 'Βλέπει πίνακα ελέγχου μέλους',
	'VIEWS'						=> 'Προβολές',
	...
	'VIEW_NEWEST_POST'			=> 'Προβολή την πρώτη από μη αναγνωσμένες δημοσιεύσεις',
	'VIEW_NOTES'				=> 'Προβολή σημειώσεων μέλους',
	'VIEW_ONLINE_TIMES'			=> array(
		1	=> 'με βάση ενεργά μέλη που ήταν ενεργά το τελευταίο %d λεπτό',
		2	=> 'με βάση ενεργά μέλη που ήταν ενεργά τα τελευταία %d λεπτά',
	),
	...
	'WATCH_FORUM_CONFIRM'	=> 'Είστε σίγουροι ότι επιθυμείτε συνδρομή σε αυτήν την Δ. Συζήτηση;',
	'WATCH_FORUM_DETAILED'	=> 'Είστε σίγουροι ότι επιθυμείτε συνδρομή στην Δ. Συζήτηση “%s”;',
	'WATCH_TOPIC_CONFIRM'	=> 'Είστε σίγουροι ότι επιθυμείτε συνδρομή σε αυτό το θέμα;',
	'WATCH_TOPIC_DETAILED'	=> 'Είστε σίγουροι ότι επιθυμείτε συνδρομή στο θέμα “%s”;',
	'WELCOME_SUBJECT'	=> 'Καλώς ήρθατε σε %s',
	'WEBSITE'			=> 'Ιστοσελίδα',
	'WHOIS'				=> 'Ποιος',
