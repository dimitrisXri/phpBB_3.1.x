...
$lang = array_merge($lang, array(
	'ACP_PERMISSIONS_EXPLAIN'	=> '
		...
		<p>Αυτές χρησιμοποιούνται για να ελέγξουν την πρόσβαση σε ένα γενικό επίπεδο και ισχύουν για ολόκληρη την Δ. Συζήτηση. Διαιρούνται περαιτέρω σε προσβάσεις μέλους, προσβάσεις ομάδας, διαχειριστές και καθολικοί συντονιστές Δ. Συζήτησης.</p>

		<h2>Προσβάσεις βασισμένες σε Δ. Συζήτηση</h2>
		<p>Αυτές χρησιμοποιούνται για τον έλεγχο της πρόσβασης σε μια κατά Δ. Συζήτηση βάση. Διαιρούνται περαιτέρω σε προσβάσεις Δ. Συζήτησης, συντονιστές Δ. Συζήτησης, προσβάσεις Δ. Συζήτησης μέλους και προσβάσεις ομάδας Δ. Συζήτησης.</p>

		<h2>Ρόλοι προσβάσεων</h2>
		<p>Αυτοί χρησιμοποιούνται για να δημιουργήσουν διαφορετικά σύνολα δικαιωμάτων πρόσβασης για τους διάφορους τύπους δικαιωμάτων που αργότερα να είναι σε θέση να ανατίθενται σε μια βασισμένη σε ρόλο βάση. Οι προεπιλεγμένοι ρόλοι θα πρέπει να καλύπτουν τη διαχείριση των Δ. Συζητήσεων μικρών και μεγάλων, αν και σε κάθε μια από τις τέσσερις ενότητες, μπορείτε να προσθέσετε / επεξεργαστείτε / διαγράψετε ρόλους, σύμφωνα την κρίση σας.</p>

		<h2>Αποτελεσματικά δικαιώματα</h2>
		<p>Αυτά χρησιμοποιούνται για να προβάλετε τις προσβάσεις που ισχύουν όπως εκχωρήθηκαν σε μέλη, συντονιστές (Δ. Συζητήσεων και καθολικούς), διαχειριστές ή Δ. Συζητήσεις.</p>

		<br />

		<p>Για περισσότερες πληροφορίες σχετικά με τη ρύθμιση και τη διαχείριση των δικαιωμάτων πρόσβασης στην phpBB3 Δ. Συζήτηση σας, παρακαλώ δείτε στην ενότητα <a href="https://www.phpbb.com/support/docs/en/3.1/ug/quickstart/permissions/">Setting permissions of our Quick Start Guide</a>.</p>
	',

	'ACL_NEVER'				=> 'Ποτέ ',
	'ACL_SET'				=> 'Ρυθμίσεις προσβάσεων',
	'ACL_SET_EXPLAIN'		=> 'Οι προσβάσεις βασίζονται σε ένα απλό <strong>ΝΑΙ</strong> / <strong>ΟΧΙ</strong> σύστημα. Η ρύθμιση μια επιλογής σε <strong>ΠΟΤΕ</strong> για ένα μέλος ή ομάδα μελών υπερισχύει κάθε άλλης τιμής έχει ανατεθεί σε αυτήν. Εάν δεν επιθυμείτε για εκχωρήσετε μια τιμή σε μια επιλογή για αυτό το μέλος ή την ομάδα, επιλέξτε <strong>ΟΧΙ</strong>. Εάν εκχωρήθηκαν τιμές για αυτή την επιλογή κάπου αλλού αυτές θα χρησιμοποιούνται κατά προτεραιότητα, διαφορετικά θεωρείται <strong>ΠΟΤΕ</strong>. Όλα τα αντικείμενα που επισημαίνονται (με το πλαίσιο επιλογής μπροστά τους) θα αντιγράψουν το σύνολο προσβάσεων που εσείς καθορίζετε.',
	...
	'ACP_ADMINISTRATORS_EXPLAIN'				=> 'Εδώ μπορείτε να εκχωρήσετε δικαιώματα διαχειριστή σε μέλη ή ομάδες. Όλα τα μέλη με δικαιώματα διαχειριστή μπορούν να δουν τον πίνακα ελέγχου διαχειριστή.',
	'ACP_FORUM_MODERATORS_EXPLAIN'				=> 'Εδώ μπορείτε να εκχωρήσετε δικαιώματα συντονιστή σε μέλη και ομάδες ως συντονιστές Δ. Συζήτησης. Για να εκχωρήσετε σε μέλη πρόσβαση στις Δ. Συζητήσεις, για να καθορίσετε τα δικαιώματα καθολικού συντονισμού ή διαχειριστές παρακαλώ χρησιμοποιήστε την κατάλληλη σελίδα.',
	...
	'ACP_GLOBAL_MODERATORS_EXPLAIN'				=> 'Εδώ μπορείτε να εκχωρήσετε δικαιώματα προσβάσεων καθολικού συντονιστή σε μέλη ή ομάδες. Αυτοί οι συντονιστές είναι σαν τους συνηθισμένους συντονιστές με τη εξαίρεση ότι έχουν πρόσβαση σε κάθε Δ. Συζήτηση της Δ. Συζήτησης σας.',
	'ACP_GROUPS_FORUM_PERMISSIONS_EXPLAIN'		=> 'Εδώ μπορείτε να εκχωρήσετε τα δικαιώματα προσβάσεων ομάδας Δ. Συζήτησης.',
	'ACP_GROUPS_PERMISSIONS_EXPLAIN'			=> 'Εδώ μπορείτε να εκχωρήσετε καθολικά δικαιώματα προσβάσεων σε ομάδες - δικαιώματα μέλους, δικαιώματα καθολικών συντονιστών και δικαιώματα διαχειριστών. Τα δικαιώματα μέλους περιλαμβάνουν δυνατότητες όπως η χρήση των άβαταρ, η αποστολή προσωπικών μηνυμάτων, κλπ.· τα δικαιώματα καθολικών συντονιστών όπως η έγκριση των δημοσιεύσεων, η διαχείριση θεμάτων, η διαχείριση αποκλεισμών, κλπ. και τέλος τα δικαιώματα των διαχειριστών όπως η αλλαγή προσβάσεων, ο καθορισμός προσαρμοσμένων BBCodes, η διαχείριση των Δ. Συζητήσεων κλπ. Δικαιώματα μεμονωμένου μέλους μέλους θα πρέπει να αλλάζουν μόνο σε σπάνιες περιπτώσεις, η προτιμώμενη μέθοδος είναι βάζοντας μέλη σε ομάδες και αναθέτοντας τα δικαιώματα ομάδας.',
	'ACP_ADMIN_ROLES_EXPLAIN'					=> 'Εδώ μπορείτε να διαχειριστείτε τους ρόλους για τα δικαιώματα διαχείρισης. Οι ρόλοι είναι αποτελεσματικά δικαιώματα, εάν αλλάξετε ένα ρόλο τα στοιχεία που τους έχει ανατεθεί αυτός ο ρόλος, θα αλλάξουν τα δικαιώματα τους επίσης.',
	'ACP_FORUM_ROLES_EXPLAIN'					=> 'Εδώ μπορείτε να διαχειριστείτε τους ρόλους για τα δικαιώματα στις Δ. Συζητήσεις. Οι ρόλοι είναι αποτελεσματικά δικαιώματα, εάν αλλάξετε ένα ρόλο τα στοιχεία που τους έχει ανατεθεί αυτός ο ρόλος, θα αλλάξουν τα δικαιώματα τους επίσης.',
	'ACP_MOD_ROLES_EXPLAIN'						=> 'Εδώ μπορείτε να διαχειριστείτε τους ρόλους για τα δικαιώματα συντονισμού. Οι ρόλοι είναι αποτελεσματικά δικαιώματα, εάν αλλάξετε ένα ρόλο τα στοιχεία που τους έχει ανατεθεί αυτός ο ρόλος, θα αλλάξουν τα δικαιώματα τους επίσης.',
	'ACP_USER_ROLES_EXPLAIN'					=> 'Εδώ μπορείτε να διαχειριστείτε τους ρόλους για τα δικαιώματα μέλους. Οι ρόλοι είναι αποτελεσματικά δικαιώματα, εάν αλλάξετε ένα ρόλο τα στοιχεία που τους έχει ανατεθεί αυτός ο ρόλος, θα αλλάξουν τα δικαιώματα τους επίσης.',
	'ACP_USERS_FORUM_PERMISSIONS_EXPLAIN'		=> 'Εδώ μπορείτε να εκχωρήσετε δικαιώματα προσβάσεων Δ. Συζητήσεων σε μέλη.',
	'ACP_USERS_PERMISSIONS_EXPLAIN'				=> 'Εδώ μπορείτε να εκχωρήσετε καθολικά δικαιώματα σε μέλη - δικαιώματα μέλους, δικαιώματα καθολικών συντονιστών και δικαιώματα των διαχειριστών. Τα δικαιώματα μέλους περιλαμβάνουν δυνατότητες όπως η χρήση των άβαταρ, η αποστολή προσωπικών μηνυμάτων, κλπ.· τα δικαιώματα καθολικών συντονιστών όπως είναι η έγκριση δημοσιεύσεων, η διαχείριση θεμάτων, η διαχείριση απαγορεύσεων, κλπ. και τέλος τα δικαιώματα των διαχειριστών όπως η αλλαγή προσβάσεων, ο καθορισμός προσαρμοσμένων BBCodes, η διαχείριση Δ. Συζητήσεις, κλπ. Για αλλάξετε αυτές τις ρυθμίσεις για μεγάλο αριθμό μελών, το σύστημα προσβάσεις ομάδας είναι η προτιμώμενη μέθοδος. Τα δικαιώματα των μελών θα πρέπει να αλλάζουν μόνο σε σπάνιες περιπτώσεις, η προτιμώμενη μέθοδος είναι βάζοντας μέλη σε ομάδες και αναθέτοντας τα δικαιώματα ομάδας.',
	'ACP_VIEW_ADMIN_PERMISSIONS_EXPLAIN'		=> 'Εδώ μπορείτε να δείτε τα αποτελεσματικά δικαιώματα διαχείρισης που εκχωρήθηκαν στα επιλεγμένα μέλη / ομάδες.',
	'ACP_VIEW_GLOBAL_MOD_PERMISSIONS_EXPLAIN'	=> 'Εδώ μπορείτε να δείτε τα αποτελεσματικά δικαιώματα συντονισμού που εκχωρήθηκαν στα επιλεγμένα μέλη / ομάδες.',
	'ACP_VIEW_FORUM_PERMISSIONS_EXPLAIN'		=> 'Εδώ μπορείτε να δείτε τα δικαιώματα πρόσβασης των Δ. Συζητήσεων που εκχωρήθηκαν στα επιλεγμένα μέλη / ομάδες και Δ. Συζητήσεις.',
	'ACP_VIEW_FORUM_MOD_PERMISSIONS_EXPLAIN'	=> 'Εδώ μπορείτε να δείτε τα δικαιώματα συντονιστών Δ. Συζητήσεων που εκχωρήθηκαν στα επιλεγμένα μέλη / ομάδες και Δ. Συζητήσεις.',
	'ACP_VIEW_USER_PERMISSIONS_EXPLAIN'			=> 'Εδώ μπορείτε να δείτε τα αποτελεσματικά δικαιώματα μέλους που εκχωρήθηκαν στα επιλεγμένα μέλη / ομάδες.',
	...
	'COPY_PERMISSIONS_CONFIRM'				=> 'Είστε σίγουροι ότι θέλετε να πραγματοποιήσετε αυτή την λειτουργία; Παρακαλώ να λάβετε υπόψη ότι αυτό θα αντικαταστήσει τα υπάρχοντα τα δικαιώματα στους επιλεγμένους στόχους.',
	...
	'DELETE_ROLE_CONFIRM'		=> 'Είστε σίγουροι ότι θέλετε να αφαιρέσετε αυτόν τον ρόλο; Τα στοιχεία που τους έχει αποδοθεί αυτός ο ρόλος <strong>δεν</strong> θα χάσουν τις ρυθμίσεις πρόσβασης τους.',
	...
	'GROUPS_NOT_ASSIGNED'		=> 'Σε καμία ομάδα ανατέθηκε αυτός τον ρόλος',
	...
	'NO_ROLE_ASSIGNED'			=> 'Δεν ανατέθηκε κανένας ρόλος…',
	...
	'ROLE_ASSIGNED_TO'				=> 'Μέλη / ομάδες που ανατέθηκε %s',
	...
	'ROLE_DESCRIPTION_ADMIN_FULL'			=> 'Έχει πρόσβαση σε όλες τις διαχειριστικές λειτουργίες αυτής της Δ. Συζήτησης.<br />Δεν προτείνεται.',
	...
	'ROLE_DESCRIPTION_FORUM_READONLY'		=> 'Μπορεί να διαβάσει την Δ. Συζήτηση, αλλά δεν μπορεί να δημιουργήσει νέα θέματα ή να απαντήσει σε δημοσιεύσεις.',
	...
	'ROLE_DESCRIPTION_MOD_QUEUE'			=> 'Μπορεί να χρησιμοποιήσει την σειρά αναμονής για να επικυρώσει και να επεξεργαστεί δημοσιεύσεις, αλλά τίποτα άλλο.',
	'ROLE_DESCRIPTION_MOD_SIMPLE'			=> 'Μπορεί να χρησιμοποιήσει τις βασικές ενέργειες θέματος. Δεν μπορεί να στείλει προειδοποιήσεις ή να χρησιμοποιήσει την σειρά αναμονής.',
	...
	'TRACE_DEFAULT'					=> 'Εξ ορισμού κάθε πρόσβαση είναι <strong>ΟΧΙ</strong> (απενεργοποιημένο). Έτσι η πρόσβαση μπορεί να αντικατασταθεί από άλλες ρυθμίσεις.',
	...
	'TRACE_GROUP_NEVER_TOTAL_NEVER_LOCAL'	=> 'Τα δικαιώματα πρόσβασης αυτής της ομάδας για αυτήν την Δ. Συζήτηση έχουν τεθεί σε <strong>ΠΟΤΕ</strong> όπως και το αποτέλεσμα συνόλου, έτσι το παλαιό αποτέλεσμα διατηρείται.',
	...
	'TRACE_GROUP_NEVER_TOTAL_NO_LOCAL'	=> 'Τα δικαιώματα πρόσβασης αυτής της ομάδας για αυτήν την Δ. Συζήτηση έχουν τεθεί σε <strong>ΠΟΤΕ</strong> το οποίο γίνεται η νέα τιμή συνόλου, επειδή ακόμη δεν είχε τεθεί (θέστε σε <strong>ΟΧΙ</strong>).',
	...
	'TRACE_GROUP_NEVER_TOTAL_YES_LOCAL'	=> 'Τα δικαιώματα πρόσβασης αυτής της ομάδας για αυτήν την Δ. Συζήτηση έχουν τεθεί σε <strong>ΠΟΤΕ</strong> το οποίο αντικαθιστά το σύνολο <strong>ΝΑΙ</strong> σε <strong>ΠΟΤΕ</strong> για αυτό το μέλος.',
	...
	'TRACE_GROUP_NO_LOCAL'			=> 'Τα δικαιώματα πρόσβασης είναι <strong>ΟΧΙ</strong> για αυτήν την ομάδα μέσα σε αυτήν την Δ. Συζήτηση, έτσι η παλαιά τιμή συνόλου διατηρείται.',
	...
	'TRACE_GROUP_YES_TOTAL_NEVER_LOCAL'	=> 'Τα δικαιώματα πρόσβασης αυτής της ομάδας για αυτήν την Δ. Συζήτηση έχουν τεθεί σε <strong>ΝΑΙ</strong> όμως στο σύνολο <strong>ΠΟΤΕ</strong> δεν μπορεί να αντικατασταθεί.',
	...
	'TRACE_GROUP_YES_TOTAL_NO_LOCAL'	=> 'Τα δικαιώματα πρόσβασης αυτής της ομάδας για αυτήν την Δ. Συζήτηση έχουν τεθεί <strong>ΝΑΙ</strong> το οποίο γίνεται η νέα τιμή συνόλου, επειδή ακόμη δεν είχε τεθεί (θέστε σε <strong>ΟΧΙ</strong>).',
	...
	'TRACE_GROUP_YES_TOTAL_YES_LOCAL'	=> 'Τα δικαιώματα πρόσβασης αυτής της ομάδας για αυτήν την Δ. Συζήτηση έχουν τεθεί <strong>ΝΑΙ</strong> και η συνολική πρόσβαση έχει ήδη τεθεί <strong>ΝΑΙ</strong>, έτσι το αποτέλεσμα συνόλου διατηρείται.',
	...
	'TRACE_USER_KEPT_LOCAL'					=> 'Τα δικαιώματα πρόσβασης του μέλους για αυτήν την Δ. Συζήτηση είναι <strong>ΟΧΙ</strong>, έτσι η παλαιά τιμή συνόλου διατηρείται.',
	...
	'TRACE_USER_NEVER_TOTAL_NEVER_LOCAL'	=> 'Τα δικαιώματα πρόσβασης του μέλους είναι για αυτήν την Δ. Συζήτηση έχουν τεθεί σε <strong>ΠΟΤΕ</strong> και η τιμή συνόλου έχει τεθεί <strong>ΠΟΤΕ</strong>, έτσι τίποτα δεν αλλάζει.',
	'TRACE_USER_NEVER_TOTAL_NO'				=> 'Τα δικαιώματα πρόσβασης του μέλους έχουν τεθεί σε <strong>ΠΟΤΕ</strong> η οποία γίνεται η τιμή συνόλου, επειδή τέθηκε το ΟΧΙ.',
	'TRACE_USER_NEVER_TOTAL_NO_LOCAL'		=> 'Τα δικαιώματα πρόσβασης του μέλους για αυτήν την Δ. Συζήτηση έχουν τεθεί σε <strong>ΠΟΤΕ</strong> η οποία γίνεται η τιμή συνόλου, επειδή τέθηκε σε ΟΧΙ.',
	...
	'TRACE_USER_NEVER_TOTAL_YES_LOCAL'		=> 'Τα δικαιώματα πρόσβασης του μέλους για αυτήν την Δ. Συζήτηση έχουν τεθεί σε <strong>ΠΟΤΕ</strong> και αντικαθιστά το προηγούμενο <strong>ΝΑΙ</strong>.',
	...
	'TRACE_USER_NO_TOTAL_NO_LOCAL'			=> 'Τα δικαιώματα πρόσβασης του μέλους για αυτήν την Δ. Συζήτηση έχουν τεθεί σε <strong>ΟΧΙ</strong> και η τιμή συνόλου έχει τεθεί ΟΧΙ, έτσι προεπιλέγεται σε <strong>ΠΟΤΕ</strong>.',
	...
	'TRACE_USER_YES_TOTAL_NEVER_LOCAL'		=> 'Τα δικαιώματα πρόσβασης του μέλους για αυτήν την Δ. Συζήτηση έχουν τεθεί σε <strong>ΝΑΙ</strong> όμως στο σύνολο <strong>ΠΟΤΕ</strong> δεν μπορεί να αντικατασταθεί.',
	...
	'TRACE_USER_YES_TOTAL_NO_LOCAL'			=> 'Τα δικαιώματα πρόσβασης του μέλους για αυτήν την Δ. Συζήτηση έχουν τεθεί σε <strong>ΝΑΙ</strong> η οποία γίνεται η τιμή συνόλου, επειδή τέθηκε σε <strong>ΟΧΙ</strong>.',
	...
	'TRACE_USER_YES_TOTAL_YES_LOCAL'		=> 'Τα δικαιώματα πρόσβασης του μέλους για αυτήν την Δ. Συζήτηση έχουν τεθεί σε <strong>ΝΑΙ</strong> και η τιμή συνόλου έχει τεθεί σε <strong>ΝΑΙ</strong>, έτσι τίποτα δεν αλλάζει.',
	'TRACE_WHO'								=> 'Ποιοι ',
	'TRACE_TOTAL'							=> 'Σύνολο',

	'USERS_NOT_ASSIGNED'			=> 'Δεν υπάρχουν μέλη που τους ανατέθηκε αυτός ρόλος',
