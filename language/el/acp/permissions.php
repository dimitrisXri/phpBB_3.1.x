...
$lang = array_merge($lang, array(
	...
	'ACL_SET_EXPLAIN'		=> 'Οι προσβάσεις βασίζονται σε ένα απλό <strong>ΝΑΙ</strong> / <strong>ΟΧΙ</strong> σύστημα. Η ρύθμιση μια επιλογής σε <strong>ΠΟΤΕ</strong> για ένα μέλος ή ομάδα μελών αντικαθιστά κάθε άλλη τιμή που έχει ανατεθεί σε αυτήν. Εάν δεν επιθυμείτε για αναθέσετε μια τιμή σε μια επιλογή για αυτό το μέλος ή την ομάδα, επιλέξτε <strong>ΟΧΙ</strong>. Εάν ανατέθηκαν τιμές για αυτή την επιλογή κάπου αλλού αυτές θα χρησιμοποιούνται κατά προτεραιότητα, διαφορετικά θεωρείται <strong>ΠΟΤΕ</strong>. Όλα τα αντικείμενα που επισημαίνονται (με το πλαίσιο επιλογής μπροστά τους) θα αντιγράψουν το σύνολο προσβάσεων που εσείς καθορίζετε.',
	...
	'ACP_GLOBAL_MODERATORS_EXPLAIN'				=> 'Εδώ μπορείτε να αναθέσετε δικαιώματα προσβάσεων καθολικού συντονιστή σε μέλη ή ομάδες. Αυτοί οι συντονιστές είναι σαν τους συνηθισμένους συντονιστές με τη εξαίρεση ότι έχουν πρόσβαση σε κάθε Δ. Συζήτηση της Δ. Συζήτησης σας.',
	...
	'DELETE_ROLE_CONFIRM'		=> 'Είστε σίγουροι ότι θέλετε να αφαιρέσετε αυτόν τον ρόλο; Τα στοιχεία που τους έχει ανατεθεί αυτός ο ρόλος <strong>δεν</strong> θα χάσουν τις ρυθμίσεις πρόσβασης τους.',
