...
$lang = array_merge($lang, array(
	...
	'JAB_PASSWORD_EXPLAIN'		=> '<em><strong>ΠΡΟΕΙΔΟΠΟΙΗΣΗ:</strong> Αυτός ο κωδικός πρόσβασης θα αποθηκευτεί σαν απλό κείμενο στη βάση δεδομένων, ορατός σε όποιον μπορεί να έχει πρόσβαση στη βάση δεδομένων σας ή που μπορεί να προβάλει αυτήν τη σελίδα ρυθμίσεων.</em>',
	...
	'JAB_USERNAME_EXPLAIN'		=> 'Προσδιορίστε ένα καταχωρημένο όνομα χρήστη ή μια έγκυρη JID. Το όνομα χρήστη δεν θα ελέγχεται για την εγκυρότητα. Εάν καθορίσετε μόνον ένα όνομα χρήστη, τότε JID σας θα είναι το όνομα χρήστη και ο διακομιστής που καθορίζονται παραπάνω. Αλλιώς, καθορίστε ένα έγκυρο JID, για παράδειγμα user@jabber.org.',
));
