...
// Ranks
$lang = array_merge($lang, array(
	'ACP_RANKS_EXPLAIN'		=> 'Χρησιμοποιώντας αυτήν την φόρμα μπορείτε να προσθέσετε, να επεξεργαστείτε, να προβάλετε και να διαγράψετε βαθμούς. Μπορείτε επίσης να δημιουργήσετε ειδικούς βαθμούς που μπορούν να εφαρμοστούν σε ένα μέλος μέσω του μηχανισμού διαχείρισης μέλους.',
