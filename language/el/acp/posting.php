...
$lang = array_merge($lang, array(
	...
	'BBCODE_DANGER'				=> 'Το BBCode που προσπαθείτε να προσθέσετε φαίνεται ότι χρησιμοποιεί ένα σύμβολο {TEXT} μέσα σε όρισμα HTML. Αυτό είναι ένα πιθανό θέμα ασφάλειας XSS. Προσπαθήστε να χρησιμοποιήσετε τους πιο περιοριστικούς {SIMPLETEXT} ή {INTTEXT} τύπους αντί αυτού. Προχωρήστε μόνο, εάν έχετε κατανοήσει τους κινδύνους που εμπεριέχονται και θεωρείτε την χρήση του {TEXT} απολύτως αναπόφευκτη.',
	'BBCODE_DANGER_PROCEED'		=> 'Προχωρήστε, καταλαβαίνω τον κίνδυνο',

	'BBCODE_ADDED'				=> 'Το BBCode προστέθηκε με επιτυχία.',
	'BBCODE_EDITED'				=> 'Το BBCode επεξεργάστηκε με επιτυχία.',
	'BBCODE_DELETED'			=> 'Το BBCode διαγράφτηκε με επιτυχία.',
	'BBCODE_NOT_EXIST'			=> 'Το BBCode που επιλέξατε δεν υπάρχει.',
	'BBCODE_HELPLINE'			=> 'Γραμμή βοήθειας',
	'BBCODE_HELPLINE_EXPLAIN'	=> 'Το πεδίο αυτό περιέχει το κείμενο, το οποίο θα εμφανίζεται στην γραμμή βοήθειας, εάν ο δείκτης του ποντικιού είναι πάνω στο BBCode.',
	...
	'BBCODE_INVALID'			=> 'Το BBCode σας είναι δομημένο σε μια άκυρη μορφή.',
	'BBCODE_OPEN_ENDED_TAG'		=> 'Η καθορισμένη από το μέλος BBCode ετικέτα πρέπει να περιέχει και μια ανοιχτή και μια κλειστή ετικέτα.',
	'BBCODE_TAG'				=> 'Ετικέτα',
	'BBCODE_TAG_TOO_LONG'		=> 'Το όνομα ετικέτας που επιλέξατε είναι πολύ μεγάλο.',
	'BBCODE_TAG_DEF_TOO_LONG'	=> 'Ο καθορισμός ετικέτας που έχετε εισαγάγει είναι πολύ μεγάλος, παρακαλώ μειώστε τον καθορισμό της ετικέτας σας.',
	'BBCODE_USAGE'				=> 'BBCode χρήση',
	'BBCODE_USAGE_EXAMPLE'		=> '[highlight={COLOR}]{TEXT}[/highlight]<br /><br />[font={SIMPLETEXT1}]{SIMPLETEXT2}[/font]',
	'BBCODE_USAGE_EXPLAIN'		=> 'Εδώ καθορίσετε τον τρόπο χρήσης του BBCode. Αντικαταστήστε οποιαδήποτε μεταβλητή εισαγωγής με το αντίστοιχο διακριτικό (%sδείτε παρακάτω%s).',
	...
	'HTML_REPLACEMENT_EXPLAIN'		=> 'Εδώ καθορίσετε την προεπιλεγμένη HTML αντικατάσταση. Μην ξεχάστε να ξαναβάλετε τα Διακριτικά που χρησιμοποιήσατε παραπάνω!',

	'TOKEN'					=> 'Διακριτικό',
	'TOKENS'				=> 'Διακριτικά',
	'TOKENS_EXPLAIN'		=> 'Διακριτικά είναι δεσμευμένες θέσεις για την εισαγωγή του μέλους. Η εισαγωγή θα επικυρωθεί μόνο εάν ταιριάζει με τον αντίστοιχο ορισμό. Εάν χρειάζεται, μπορείτε να τα αριθμήσετε προσθέτοντας έναν αριθμό, ανάμεσα στις αγκύλες, π.χ. {TEXT1}, {TEXT2}.<br /><br />Μέσα στην αντικατάσταση HTML, μπορείτε επίσης να χρησιμοποιήσετε οποιαδήποτε συμβολοσειρά γλώσσας που υπάρχει στη γλώσσα / κατάλογο σας, όπως αυτό: {L_<em>&lt;STRINGNAME&gt;</em>} όπου <em>&lt;STRINGNAME&gt;</em> είναι το όνομα της μεταφρασμένης συμβολοσειράς που θέλετε να προσθέσετε. Για παράδειγμα, {L_WROTE} θα εμφανίζεται ως “έγραψε” ή με την μετάφρασή του σύμφωνα με την τοπική ρύθμιση του μέλους.<br /><br /><strong>Παρακαλώ σημειώστε ότι μόνο διακριτικά που αναγράφονται παρακάτω είναι σε θέση να χρησιμοποιηθούν μέσα στα προσαρμοσμένα BBCodes.</strong>',
	'TOKEN_DEFINITION'		=> 'Τι είναι συγκεκριμένα;',
	'TOO_MANY_BBCODES'		=> 'Δεν μπορείτε να δημιουργήσετε περισσότερα BBCodes. Παρακαλώ διαγράψτε ένα ή περισσότερα BBCodes και προσπαθήστε πάλι',

	'tokens'	=>	array(
		'TEXT'			=> 'Οποιοδήποτε κείμενο, συμπεριλαμβανομένων των ξένων χαρακτήρων, αριθμών, κλπ… Δεν πρέπει να χρησιμοποιήσετε αυτό το διακριτικό σε ετικέτες HTML. Αντί αυτού προσπαθείτε να χρησιμοποιήσετε IDENTIFIER, INTTEXT ή SIMPLETEXT.',
		...
		'RELATIVE_URL'	=> 'Μια σχετική διεύθυνση URL. Μπορείτε να χρησιμοποιήσετε αυτό για να ταιριάζει με τα μέρη μιας διεύθυνσης URL, αλλά να είστε προσεκτικοί: μια πλήρη διεύθυνση URL είναι μια έγκυρη σχετική διεύθυνση URL. Όταν θέλετε να χρησιμοποιήσετε τις σχετικές διευθύνσεις της Δ. Συζήτησής σας, χρησιμοποιήστε το σύμβολο LOCAL_URL.',
...
$lang = array_merge($lang, array(
	...
	'ICONS_NOT_DISPLAYED'	=> 'Τα ακόλουθα εικονίδιο δεν θα εμφανίζονται στην σελίδα δημοσίευσης',
...
// Ranks
$lang = array_merge($lang, array(
	'ACP_RANKS_EXPLAIN'		=> 'Χρησιμοποιώντας αυτήν την φόρμα μπορείτε να προσθέσετε, να επεξεργαστείτε, να προβάλετε και να διαγράψετε βαθμούς. Μπορείτε επίσης να δημιουργήσετε ειδικούς βαθμούς που μπορούν να εφαρμοστούν σε ένα μέλος μέσω του μηχανισμού διαχείρισης μελους.',
	'ADD_RANK'				=> 'Προσθήκη νέου βαθμού',

	'MUST_SELECT_RANK'		=> 'Πρέπει να επιλέξετε έναν βαθμό.',

	'NO_ASSIGNED_RANK'		=> 'Κανένας ειδικός βαθμός δεν καθορίστηκε.',
...
// Reasons
$lang = array_merge($lang, array(
	'ACP_REASONS_EXPLAIN'	=> 'Εδώ μπορείτε να διαχειριστείτε τους λόγους που χρησιμοποιούνται σε αναφορές και μηνύματα κατά την απόρριψη δημοσιεύσεων. Υπάρχει ένας τυποποιημένος λόγος (σημειωμένος με *), ο οποίος δεν μπορεί να διαγραφεί. Αυτός ο λόγος χρησιμοποιείται κατά κανόνα για προσαρμοσμένα μηνύματα, εάν δεν υπάρχει λόγος που ταιριάζει.',
	...
	'IS_NOT_TRANSLATED_EXPLAIN'	=> 'Ο λόγος <strong>δεν</strong> έχει μεταφραστεί. Εάν θέλετε να παράσχει την μεταφρασμένη μορφή, καθορίστε το σωστό κλειδί από τα αρχεία γλώσσας της ενότητας λόγων αναφοράς.',
	...
	'NO_REMOVE_DEFAULT_REASON'	=> 'Δεν μπορείτε να διαγράψετε τον λόγο προεπιλογής “Διάφορα”.',
