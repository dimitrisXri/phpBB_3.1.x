...
$lang = array_merge($lang, array(
	...
	'EXTENSION_DELETE_DATA_CONFIRM'	=> 'Είστε σίγουρος (-η) ότι θέλετε να διαγράψετε τα δεδομένα που σχετίζονται με “%s”;<br /><br />Αυτό αφαιρεί όλα τα δεδομένα και τις ρυθμίσεις της και δεν μπορεί να αναιρεθεί!',
	'EXTENSION_DISABLE_CONFIRM'		=> 'Είστε σίγουρος (-η) ότι θέλετε να απενεργοποιήσετε την “%s” επέκταση;',
	'EXTENSION_ENABLE_CONFIRM'		=> 'Είστε σίγουρος (-η) ότι θέλετε να ενεργοποιήσετε την “%s” επέκταση;',
