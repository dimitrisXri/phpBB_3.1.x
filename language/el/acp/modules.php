...
$lang = array_merge($lang, array(
	...
	'ADD_MODULE_CONFIRM'			=> 'Είστε σίγουροι ότι θέλετε να προσθέσετε την επιλεγμένη μονάδα με τον επιλεγμένο τρόπο λειτουργίας',
	...
	'CHOOSE_MODULE_EXPLAIN'	=> 'Επιλέξτε το αρχείο το οποίο καλείται από αυτή την μονάδα.',
	'CREATE_MODULE'			=> 'Δημιουργία νέας μονάδας',

	'DEACTIVATED_MODULE'	=> 'Απενεργοποίηση μονάδας',
	'DELETE_MODULE'			=> 'Διαγραφή μονάδας',
	'DELETE_MODULE_CONFIRM'	=> 'Είστε σίγουροι ότι θέλετε να διαγράψετε αυτήν την μονάδα;',

	'EDIT_MODULE'			=> 'Επεξεργασία μονάδας',
	'EDIT_MODULE_EXPLAIN'	=> 'Εδώ έχετε τη δυνατότητα να εισάγετε συγκεκριμένες ρυθμίσεις για την μονάδα.',
	...
	'MODULE_DISPLAYED_EXPLAIN'	=> 'Εάν δεν επιθυμείτε να εμφανίζετε η μονάδα, αλλά θέλετε να την χρησιμοποιείτε καθορίστε αυτό σε “Όχι”.',
	...
	'NO_CATEGORY_TO_MODULE'	=> 'Δεν είναι δυνατό να μετατραπεί η κατηγορία σε μονάδα. Παρακαλώ αφαιρέστε / μετακινήσετε όλες τις υπό-μονάδες πριν από την εκτέλεση αυτής της ενέργειας.',
