...
// User Permissions
$lang = array_merge($lang, array(
	'ACL_U_VIEWPROFILE'	=> 'Μπορεί να προβάλει προφίλ, λίστα μελών και την σε σύνδεση λίστα',
	...
	'ACL_U_HIDEONLINE'	=> 'Μπορεί να κάνει απόκρυψη την σε απευθείας σύνδεση κατάσταση ',
...
// Admin Permissions
$lang = array_merge($lang, array(
	'ACL_A_BOARD'		=> 'Μπορεί να αλλάξει Δ. Συζήτησης ρυθμίσεις / έλεγχο για ενημερώσεις',
	...
	'ACL_A_USER'		=> 'Μπορεί να διαχειριστεί μέλη<br /><em>Αυτό συμπεριλαμβάνει επίσης να δει τον πράκτορα του προγράμματος περιήγησης των μελών μέσα στην λίστα μέλη σε σύνδεση.</em>',
