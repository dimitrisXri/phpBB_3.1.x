...
$lang = array_merge($lang, array(
	'ACP_ATTACHMENT_SETTINGS_EXPLAIN'	=> 'Εδώ μπορείτε να παραμετροποιήσετε τις βασικές ρυθμίσεις για τα συνημμένα και τις σχετικές ειδικές κατηγορίες.',
	'ACP_EXTENSION_GROUPS_EXPLAIN'		=> 'Εδώ μπορείτε να προσθέσετε, να διαγράψετε, να τροποποιήσετε ή να απενεργοποιήσετε τις ομάδες επεκτάσεων σας. Πρόσθετες επιλογές περιλαμβάνουν την ανάθεση ειδικών κατηγοριών σε αυτές, αλλάζοντας τον μηχανισμό μεταφόρτωσης και τον καθορισμό ενός εικονιδίου φόρτωσης το οποίο θα εμφανίζεται μπροστά από το συνημμένο που ανήκει στην ομάδα.',
	...
	'ACP_ORPHAN_ATTACHMENTS_EXPLAIN'	=> 'Εδώ μπορείτε να δείτε ορφανά αρχεία. Αυτό συμβαίνει κυρίως αν τα μέλη επισυνάπτουν αρχεία, αλλά δεν υποβάλουν την δημοσίευση. Μπορείτε να διαγράψετε τα αρχεία ή να τα επισυνάψετε σε υπάρχουσες δημοσιεύσεις. Επισύναψη σε δημοσιεύσεις απαιτεί ένα έγκυρο αναγνωριστικό δημοσίευσης (post ID), το οποίο πρέπει να καθορίσετε αυτό το αναγνωριστικό από μόνοι σας. Αυτό θα αντιστοιχίσει το ήδη φορτωμένο συνημμένο στη δημοσίευση που έχετε εισάγει.',
	...
	'ATTACH_QUOTA_EXPLAIN'				=> 'Μέγιστος διαθέσιμος χώρος στην μονάδα δίσκου για ολόκληρη την Δ. Συζήτηση, με 0 να είναι απεριόριστο.',
	...
	'DOWNLOAD_ADD_IPS_EXPLAIN'		=> 'Για να ορίσετε πολλές διαφορετικές διευθύνσεις IP ή ονόματα εξυπηρετητών πληκτρολογήστε το καθένα σε διαφορετική γραμμή. Για να ορίσετε ένα εύρος διευθύνσεων IP διαχωρίστε την αρχή και το τέλος με μια παύλα (-), για να καθορίσετε ένα μπαλαντέρ χρησιμοποιήστε “*”.',
	...
	'DISPLAY_INLINED_EXPLAIN'		=> 'Αν ρυθμιστεί σε “Όχι” οι συνημμένες εικόνες θα εμφανίζονται σαν δεσμός.',
	...
	'MAX_THUMB_WIDTH_EXPLAIN'		=> 'Μια μικρογραφία που δημιουργείται δεν θα υπερβαίνει το πλάτος που ορίζεται εδώ.',
	'MIN_THUMB_FILESIZE'			=> 'Ελάχιστο μέγεθος αρχείου μικρογραφίας',
	'MIN_THUMB_FILESIZE_EXPLAIN'	=> 'Μην δημιουργείτε μια μικρογραφία για εικόνες μικρότερες από αυτό.',
	...
	'NO_THUMBNAIL_SUPPORT'		=> 'Η υποστήριξη μικρογραφίας έχει απενεργοποιηθεί. Για την σωστή λειτουργία είτε θα πρέπει να είναι διαθέσιμη η επέκταση GD, είτε να είναι εγκατεστημένο το Ιmagemagick. Αμφότερα δεν βρέθηκαν.',
	'NO_UPLOAD_DIR'				=> 'Ο κατάλογος φόρτωσης που καθορίσατε δεν υπάρχει.',
	'NO_WRITE_UPLOAD'			=> 'Ο κατάλογος φόρτωσης που καθορίσατε δεν μπορεί να εγγραφεί. Παρακαλώ αλλάξτε τα δικαιώματα για να επιτρέψετε στον διακομιστή να εγγράψει σε αυτόν.',
	...
	'RESYNC_FILES_STATS_CONFIRM'	=> 'Είστε σίγουροι ότι θέλετε να επανασυγχρονίσετε τα στατιστικά αρχείων;',

	'SEARCH_IMAGICK'				=> 'Αναζήτηση για Imagemagick',
	'SECURE_ALLOW_DENY'				=> 'Λίστα επιτρεπτών / μη επιτρεπτών',
	'SECURE_ALLOW_DENY_EXPLAIN'		=> 'Αλλάζει την προεπιλεγμένη συμπεριφορά όταν οι ασφαλείς μεταφορτώσεις είναι ενεργοποιημένες στην λίστα επιτρεπτών / μη επιτρεπτών με εκείνη μιας <strong>λίστας επιτρεπόμενων</strong> (Allow) ή μιας <strong>μαύρης λίστας</strong> (Deny).',
	...
	'UPLOAD_DENIED_FORUM'			=> 'Δεν έχετε τα απαραίτητα δικαιώματα για φόρτωση αρχείου στην δημόσια συζήτηση “%s”.',
	...
	'UPLOAD_ICON'					=> 'Φόρτωσης εικονίδιο',
