...
$lang = array_merge($lang, array(
	...
	'ACP_LANGUAGE_PACKS_EXPLAIN'	=> 'Εδώ μπορείτε να εγκαταστήσετε / από-εγκαταστήσετε πακέτα γλώσσας. Το πακέτο προκαθορισμένης γλώσσας επισημαίνεται με έναν αστερίσκο (*).',
	...
	'LANGUAGE_PACK_DELETED'				=> 'Το αρχείο γλώσσας “%s” αφαιρέθηκε με επιτυχία. Όλα τα μέλη που χρησιμοποιούσαν αυτήν την γλώσσας ρυθμίσθηκαν στην προκαθορισμένη γλώσσα της Δ. Συζήτησης.',
	'LANGUAGE_PACK_DETAILS'				=> 'Λεπτομέρειες πακέτου γλώσσας',
	'LANGUAGE_PACK_INSTALLED'			=> 'Το αρχείο γλώσσας “%s” εγκαταστάθηκε με επιτυχία.',
	'LANGUAGE_PACK_CPF_UPDATE'			=> 'Οι συμβολοσειρές γλώσσας των προσαρμοσμένων πεδίων προφίλ αντιγράφονται από την προκαθορισμένη γλώσσα. Παρακαλώ αλλάξτε τα εάν απαιτείται.',
	...
	'NO_REMOVE_DEFAULT_LANG'		=> 'Δεν μπορείτε να από-εγκαταστήσετε το προκαθορισμένο πακέτο γλώσσας.<br />Αν θέλετε να το από-εγκαταστήσετε, αλλάξτε πρώτα την προκαθορισμένη γλώσσα της Δ. Συζήτησης.',
