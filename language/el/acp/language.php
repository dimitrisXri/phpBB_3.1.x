...
$lang = array_merge($lang, array(
	...
	'LANGUAGE_PACK_DELETED'				=> 'Το αρχείο γλώσσας “%s” έχει αφαιρεθεί με επιτυχία. Όλα τα μέλη που χρησιμοποιούσαν αυτήν την γλώσσας ρυθμίσθηκαν στην προεπιλεγμένη γλώσσα της Δ. Συζήτησης.',
	...
	'NO_REMOVE_DEFAULT_LANG'		=> 'Δεν μπορείτε να από-εγκαταστήσετε το προεπιλεγμένο πακέτο γλώσσας.<br />Αν θέλετε να το από-εγκαταστήσετε, αλλάξτε πρώτα την προεπιλεγμένη γλώσσα της Δ. Συζήτησης.',
