...
// PHP info
$lang = array_merge($lang, array(
	'ACP_PHP_INFO_EXPLAIN'	=> 'Αυτή η σελίδα περιέχει πληροφορίες για την έκδοση PHP που είναι εγκατεστημένη σε αυτόν τον διακομιστή. Περιέχει λεπτομέρειες για τις φορτωμένες μονάδες, τις διαθέσιμες μεταβλητές και προεπιλεγμένες ρυθμίσεις. Αυτές οι πληροφορίες μπορεί να είναι χρήσιμες κατά τη διάγνωση προβλημάτων. Παρακαλούμε να λάβετε υπόψη ότι ορισμένες εταιρείες φιλοξενίας ιστοσελίδων μπορεί να περιορίζουν τις πληροφορίες που εμφανίζονται εδώ για λόγους ασφαλείας. Σας συνιστούμε να μην δίνετε οποιεσδήποτε λεπτομέρειες σχετικά με αυτήν τη σελίδα, εκτός εάν ζητηθεί από <a href="https://www.phpbb.com/about/team/">Επίσημα μέλη </a> της ομάδας υποστήριξης.',
