...
$lang = array_merge($lang, array(
	...
	'ACP_USERS_FORUM_PERMISSIONS'	=> 'Προσβάσεις Δ. Συζήτησης μέλους',
	...
	'CRON_NO_TASK'			=> 'Δεν υπάρχουν εργασίες cron που πρέπει να εκτελέσετε αυτή τη στιγμή.',
	...
	'INSTALL'				=> 'Εγκατάσταση',
	'IP'					=> 'IP Χρήστη',
	'IP_HOSTNAME'			=> 'Διευθύνσεις IP ή ονόματα διακομιστών',
	...
	'LOGIN_ADMIN'			=> 'Για να διαχειριστείτε την Δ. Συζήτηση πρέπει να είστε εξουσιοδοτημένο μέλος.',
	'LOGIN_ADMIN_CONFIRM'	=> 'Για να διαχειριστείτε την Δ. Συζήτηση πρέπει να επαναπιστοποιήσετε τον εαυτό σας.',
	'LOGIN_ADMIN_SUCCESS'	=> 'Εξουσιοδοτηθήκατε με επιτυχία και τώρα θα προωθηθείτε στον Πίνακα Ελέγχου Διαχειριστή.',
	...
	'NOTIFY'				=> 'Ειδοποίηση',
	'NO_ADMIN'				=> 'Δεν είστε εξουσιοδοτημένοι να διαχειριστείτε αυτήν την Δ. Συζήτηση.',
	...
	'PERMISSIONS_TRANSFERRED_EXPLAIN'	=> 'Αυτήν τη στιγμή έχετε τα δικαιώματα από %1$s. Μπορείτε τώρα να περιηγηθείτε στην Δ. Συζήτηση με τα δικαιώματα του μέλους, αλλά δεν έχετε πρόσβαση στον Πίνακα Ελέγχου Διαχειριστή εφόσον προσβάσεις διαχειριστή δεν μεταβιβάσθηκαν. Μπορείτε να <a href="%2$s"><strong>επαναφέρετε τις προσβάσεις σας</strong></a> οποιαδήποτε στιγμή.',
	...
	'SETTING_TOO_LOW'		=> 'Η παρεχόμενη τιμή για την ρύθμιση “%1$s” είναι πολύ μικρή. Η ελάχιστη αποδεκτή τιμή είναι %2$d.',
	'SETTING_TOO_BIG'		=> 'Η παρεχόμενη τιμή για την ρύθμιση “%1$s” είναι πολύ μεγάλη. Η μέγιστη αποδεκτή τιμή είναι %2$d.',
	'SETTING_TOO_LONG'		=> 'Η παρεχόμενη τιμή για την ρύθμιση “%1$s” είναι πολύ μεγάλη. Το μέγιστο μήκος που επιτρέπετε είναι %2$d.',
	'SETTING_TOO_SHORT'		=> 'Η παρεχόμενη τιμή για την ρύθμιση “%1$s” είναι πολύ μικρή. Το ελάχιστο μήκος που επιτρέπετε είναι %2$d.',
...
// Index page
$lang = array_merge($lang, array(
	'ADMIN_INTRO'				=> 'Σας ευχαριστούμε για την επιλογή phpBB ως λύση της Δ. Συζήτηση σας. Αυτή η οθόνη θα σας δώσει μια γρήγορη επισκόπηση όλων των διαφόρων στατιστικών της Δ. Συζήτησης σας. Οι σύνδεσμοι στην αριστερή πλευρά αυτής της οθόνης σάς επιτρέπουν να ελέγχετε κάθε πτυχή της εμπειρίας Δ. Συζήτησης σας. Κάθε σελίδα θα έχει οδηγίες για το πώς να χρησιμοποιήσετε τα εργαλεία.',
	...
	'BOARD_STARTED'		=> 'Ημερομηνία. εκκίνησης Δ. Συζήτησης',
	'BOARD_VERSION'		=> 'Έκδοση Δ. Συζήτησης',
	...
	'FORUM_STATS'		=> 'Στατιστικά Δ. Συζήτησης',
	...
	'PHP_VERSION_OLD'	=> 'Η έκδοση της PHP σε αυτόν το διακομιστή πλέον δεν θα υποστηρίζεται από μελλοντικές εκδόσεις του λογισμικού phpBB. %sΛεπτομέρειες%s',

	'POSTS_PER_DAY'		=> 'Δημοσιεύσεις ανά ημέρα',

	'PURGE_CACHE'			=> 'Εκκαθάριση λανθάνουσας μνήμης',
	'PURGE_CACHE_CONFIRM'	=> 'Είστε σίγουροι ότι θέλετε να εκκαθαρίσετε την λανθάνουσα μνήμη;',
	'PURGE_CACHE_EXPLAIN'	=> 'Εκκαθάριση όλων των στοιχείων που σχετίζονται με την λανθάνουσας μνήμη, αυτό περιλαμβάνει οποιαδήποτε προσωρινά αποθηκευμένα αρχεία πρότυπα ή ερωτήματα.',
	'PURGE_CACHE_SUCCESS'	=> 'Επιτυχής εκκαθάριση λανθάνουσας μνήμης.',

	'PURGE_SESSIONS'			=> 'Εκκαθάριση όλων των συνόδων',
	'PURGE_SESSIONS_CONFIRM'	=> 'Είστε σίγουροι ότι θέλετε να εκκαθαρίσετε όλες τις συνόδους; Αυτό θα αποσυνδέσει όλα τα μέλη',
	...
	'RESET_DATE'					=> 'Επαναφορά ημερομηνίας εκκίνησης Δ. Συζήτησης',
	'RESET_DATE_CONFIRM'			=> 'Είστε σίγουροι ότι θέλετε να επαναφέρετε την ημερομηνίας εκκίνησης της Δ. Συζήτησης;',
	...
	'RESET_ONLINE_CONFIRM'			=> 'Είστε σίγουροι ότι θέλετε να επαναφέρετε τον μετρητή “Περισσότερα μέλη σε σύνδεση”;',
	...
	'RESYNC_POSTCOUNTS_EXPLAIN'		=> 'Μόνο υπαρκτές δημοσιεύσεις θα ληφθούν υπόψη. Διαγραμμένες δημοσιεύσεις δεν θα προσμετρώνται.',
	'RESYNC_POSTCOUNTS_CONFIRM'		=> 'Είστε σίγουροι ότι θέλετε να επανασυγχρονίσετε τον μετρητή των δημοσιεύσεων;',
	...
	'RESYNC_POST_MARKING_CONFIRM'	=> 'Είστε σίγουροι ότι θέλετε να επανασυγχρονίσετε τα σημειωμένα θέματα;',
	...
	'RESYNC_STATS_CONFIRM'			=> 'Είστε σίγουροι ότι θέλετε να επανασυγχρονίσετε τα στατιστικά;',
...
$lang = array_merge($lang, array(
	'EXPLAIN_SEND_STATISTICS'	=> 'Παρακαλούμε στείλτε πληροφορίες σχετικά με το διακομιστή σας και ρυθμίσεις της Δ. Συζήτησης στο phpBB για στατιστική ανάλυση. Όλες οι πληροφορίες οι οποίες θα μπορούσαν να εντοπίσουν εσάς ή την ιστοσελίδα σας έχουν αφαιρεθεί - τα στοιχεία είναι εντελώς <strong>ανώνυμα</strong>. Βασίζουμε τις αποφάσεις σχετικά με μελλοντικές εκδόσεις phpBB σε αυτές τις πληροφορίες. Τα στατιστικά στοιχεία διατίθενται δημοσίως. Μοιραζόμαστε επίσης αυτά τα δεδομένα με το έργο της PHP, την γλώσσα προγραμματισμού phpBB είναι κατασκευασμένο με την οποία.',
...
$lang = array_merge($lang, array(
	...
	'LOG_ATTACH_FILEUPLOAD'		=> '<strong>Φορτώθηκε ορφανό αρχείο στην δημοσίευση</strong><br />» ID %1$d - %2$s',
	'LOG_ATTACH_ORPHAN_DEL'		=> '<strong>Διαγράφηκε ορφανό αρχείο</strong><br />» %s',

	'LOG_BAN_EXCLUDE_USER'	=> '<strong>Εξαιρέθηκε μέλος από αποκλεισμό </strong> για το λόγο “<em>%1$s</em>”<br />» %2$s',
	'LOG_BAN_EXCLUDE_IP'	=> '<strong>Εξαιρέθηκε διεύθυνση IP από αποκλεισμό</strong> για τον λόγο “<em>%1$s</em>”<br />» %2$s',
	'LOG_BAN_EXCLUDE_EMAIL' => '<strong>Εξαιρέθηκε ηλεκτρονικό ταχυδρομείο από αποκλεισμό</strong> για το λόγο “<em>%1$s</em>”<br />» %2$s',
	...
	'LOG_BBCODE_ADD'		=> '<strong>Προστέθηκε νέο BBCode</strong><br />» %s',
	...
	'LOG_CONFIG_AUTH'			=> '<strong>Άλλαξαν ρυθμίσεις εξουσιοδότησης</strong>',
	...
	'LOG_CONFIG_FEATURES'		=> '<strong>Άλλαξαν ρυθμίσεις χαρακτηριστικών Δ. Συζήτησης</strong>',
	...
	'LOG_CONFIG_SETTINGS'		=> '<strong>Άλλαξαν ρυθμίσεις Δ. Συζήτησης</strong>',
	...
	'LOG_FORK'					=> '<strong>Αντιγράφηκε θέμα</strong><br />» από %s',
	...
	'LOG_DOWNLOAD_EXCLUDE_IP'	=> '<strong>Εξαιρέθηκε διεύθυνση IP / όνομα διακομιστή από την λίστα μεταφόρτωσης</strong><br />» %s',
	'LOG_DOWNLOAD_IP'			=> '<strong>Προστέθηκε διεύθυνση IP / όνομα διακομιστή στην λίστα μεταφόρτωσης</strong><br />» %s',
	'LOG_DOWNLOAD_REMOVE_IP'	=> '<strong>Αφαιρέθηκε διεύθυνση IP / όνομα διακομιστή από την λίστα μεταφόρτωσης</strong><br />» %s',
	...
	'LOG_FORUM_COPIED_PERMISSIONS'			=> '<strong>Αντιγράφηκαν Δ. Συζήτησης δικαιώματα</strong> από %1$s<br />» %2$s',
	...
	'LOG_GROUP_DEFAULTS'	=> '<strong>Η ομάδα “%1$s” δηλώθηκε σαν βασική για μέλη</strong><br />» %2$s',
	...
	'LOG_PURGE_SESSIONS'		=> '<strong>Εκκαθαρίστηκαν συνόδοι</strong>',
	...
	// @deprecated 3.1
	'LOG_TEMPLATE_ADD_DB'			=> '<strong>Προστέθηκε νέο πακέτο προτύπων στην βάση δεδομένων</strong><br />» %s',
	// @deprecated 3.1
	...
	// @deprecated 3.1
	'LOG_THEME_ADD_DB'			=> '<strong>Προστέθηκε νέο θέμα στην βάση δεδομένων</strong><br />» %s',
	// @deprecated 3.1
	...
	'LOG_USER_MOVE_POSTS'	=> '<strong>Μετακινήθηκαν δημοσιεύεις μέλους</strong><br />» δημοσιεύσεις από “%1$s” στην δημ. συζήτηση “%2$s”',
	...
	'LOG_USER_GROUP_CHANGE'			=> '<strong>Το μέλος άλλαξε βασική ομάδα</strong><br />» %s',
