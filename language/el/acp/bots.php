...
$lang = array_merge($lang, array(
	...
	'BOT_NAME_TAKEN'	=> 'Το όνομα είναι ήδη σε χρήση στην Δ. Συζήτηση σας και δεν μπορεί να χρησιμοποιηθεί για το Bot.',
	'BOT_NEVER'			=> 'Ποτέ',
	'BOT_STYLE'			=> 'Bot στυλ',
	'BOT_STYLE_EXPLAIN'	=> 'Το στυλ που θα χρησιμοποιείται στην Δ. Συζήτηση από το bot.',
	'BOT_UPDATED'		=> 'Το υφιστάμενο bot ενημερώθηκε με επιτυχία.',

	'ERR_BOT_AGENT_MATCHES_UA'	=> 'Ο πράκτορας bot που που παρείχατε είναι παρόμοιος με αυτόν που χρησιμοποιείτε αυτήν τη στιγμή. Παρακαλούμε προσαρμόσετε τον πράκτορα για αυτό το bot.',
	'ERR_BOT_NO_IP'				=> 'Οι διευθύνσεις IP που που παρείχατε ήταν άκυρες ή το όνομα κεντρικού υπολογιστή δεν μπόρεσε να βρεθεί.',
