...
$lang = array_merge($lang, array(
	'ACP_STYLES_EXPLAIN'	=> 'Εδώ μπορείτε να διαχειριστείτε τα διαθέσιμα στυλ στην Δ. Συζήτησή σας. Μπορείτε να αλλάξετε τα υπάρχοντα στυλ, να διαγράψετε, να απενεργοποιήσετε, να ενεργοποιήστε ξανά, να εγκαταστήσετε νέα. Μπορείτε επίσης να δείτε πως μοιάζει ένα στυλ χρησιμοποιώντας την λειτουργία της προεπισκόπησης. Επίσης, αναφέρονται ο συνολικός αριθμός μελών για κάθε στυλ, σημειώστε ότι στυλ που παρακάμπτονται στο μέλος δεν αντανακλώνται εδώ.',

	'CANNOT_BE_INSTALLED'			=> 'Δεν μπορεί να εγκατασταθεί',
	'CONFIRM_UNINSTALL_STYLES'		=> 'Είστε σίγουροι ότι θέλετε να διαγράψετε τα επιλεγμένα στυλ?',
	...
	'DELETE_STYLE_FILES_FAILED'	=> 'Λάθος κατά την διαγραφή αρχείων του στυλ "%s".',
	...
	'STYLE_DEFAULT_CHANGE_INACTIVE'	=> 'Πρέπει να ενεργοποιήσετε το στυλ πριν το κάνετε στυλ προεπιλογής.',
	...
	'STYLE_INSTALLED_RETURN_INSTALLED_STYLES'	=> 'Επιστροφή στην λίστα εγκατεστημένων στυλ.',
	...
	'STYLE_UNINSTALL'			=> 'Από-εγκατάσταση',
	'STYLE_UNINSTALL_DEPENDENT'	=> 'Το στυλ "%s" δεν μπορεί να από-εγκατασταθεί επειδή κληρονομείται από ένα άλλο ή περισσότερα άλλα στυλ .',
	'STYLE_UNINSTALLED'			=> 'Το στυλ "%s" από-εγκαταστάθηκε με επιτυχία',
