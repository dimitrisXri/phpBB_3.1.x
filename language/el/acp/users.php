...
$lang = array_merge($lang, array(
	...
	'AT_LEAST_ONE_FOUNDER'	=> 'Δεν μπορείτε να αλλάξετε αυτόν τον ιδρυτή σε ένα κανονικό μέλος. Πρέπει να υπάρχει τουλάχιστον ένας ιδρυτής ενεργοποιημένος για αυτήν τήν Δ. Συζήτηση. Εάν θέλετε να αλλάξετε αυτή την κατάσταση του μέλους ιδρυτή, προάγετε πρώτα ένα άλλο μέλος να είναι ένας ιδρυτής.',
	...
	'CANNOT_DEACTIVATE_BOT'			=> 'Δεν μπορείτε να απενεργοποιήσετε bot λογαριασμούς. Παρακαλώ απενεργοποιήστε το bot μέσα στην σελίδα των bot αντί αυτού.',
	...
	'CANNOT_FORCE_REACT_BOT'		=> 'Δεν μπορείτε να επανενεργοποιήσετε bot λογαριασμούς. Παρακαλώ επανενεργοποιήσετε την στατική διεύθυνση του bot μέσα στην σελίδα.',
	...
	'CANNOT_SET_FOUNDER_INACTIVE'	=> 'Πρέπει να ενεργοποιήσετε τον λογαριασμό των μελών πριν τους προωθήσετε σε ιδρυτές, μόνο ενεργοποιημένα μέλη μπορούν να προωθηθούν.',
	'CONFIRM_EMAIL_EXPLAIN'			=> 'Πρέπει να προσδιοριστεί αυτό, μόνο αν αλλάξετε τη διεύθυνση ηλεκτρονικού ταχυδρομείου μελών.',
	...
	'MOVE_POSTS_EXPLAIN'	=> 'Παρακαλώ επιλέξτε την Δ. Συζήτηση που επιθυμείτε να μετακινήσετε όλες τις δημοσιεύσεις που αυτό το μέλος έχει κάνει.',

	'NO_SPECIAL_RANK'		=> 'Δεν έχει εκχωρηθεί ειδικός βαθμός',
	'NO_WARNINGS'			=> 'Καμία προειδοποίηση.',
	'NOT_MANAGE_FOUNDER'	=> 'Προσπαθήσατε να διαχειριστείτε ένα μέλος με την ιδιότητα του ιδρυτή. Μόνο οι ιδρυτές μπορούν να διαχειρίζονται άλλους ιδρυτές.',

	'QUICK_TOOLS'			=> 'Γρήγορα εργαλεία',

	'REGISTERED'			=> 'Έχει εγγραφεί',
	'REGISTERED_IP'			=> 'Έχει εγγραφεί από την διεύθυνση IP',
	...
	'USER_POSTS_MOVED'				=> 'Οι δημοσιεύσεις του μέλους στην στοχευμένη Δ. Συζήτηση μετακινήθηκαν με επιτυχία.',
