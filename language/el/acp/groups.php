...
$lang = array_merge($lang, array(
	...
	'ADD_USERS_EXPLAIN'				=> 'Εδώ μπορείτε να προσθέσετε νέα μέλη στην ομάδα. Μπορείτε να επιλέξετε εάν αυτή η ομάδα γίνεται η νέα προεπιλογή για τα επιλεγμένα μέλη. Επιπλέον, μπορείτε να τα ορίσετε ως συντονιστές της ομάδας. Παρακαλώ εισάγετε κάθε όνομα μέλους σε μια ξεχωριστή γραμμή.',
	...
	'GROUP_CATEGORY_NAME'			=> 'Κατηγορίας όνομα',
	...
	'GROUP_CONFIRM_ADD_USERS'		=> array(
		1	=> 'Είστε σίγουροι ότι θέλετε να προσθέσετε το μέλος %2$s στην ομάδα;',
		2	=> 'Είστε σίγουροι ότι θέλετε να προσθέσετε τα μέλη %2$s στην ομάδα;',
	),
	'GROUP_CREATED'					=> 'Η ομάδα δημιουργήθηκε με επιτυχία.',
	'GROUP_DEFAULT'					=> 'Κάνετε την ομάδα σαν βασική για το μέλος',
	'GROUP_DEFS_UPDATED'			=> 'Προεπιλεγμένη ομάδα ορίστηκε για όλα τα επιλεγμένα μέλη.',
	'GROUP_DELETE'					=> 'Αφαίρεση του μέλους από την ομάδα',
	'GROUP_DELETED'					=> 'Η ομάδα διαγράφηκε και μέλους βασική ομάδα ορίστηκε με επιτυχία.',
	...
	'GROUP_MAX_RECIPIENTS_EXPLAIN'	=> 'Ο μέγιστος αριθμός των επιτρεπόμενων παραληπτών σε ένα προσωπικό μήνυμα. Εάν εισαχθεί 0, θα χρησιμοποιηθεί η ρύθμιση της ευρύτερης Δ. Συζήτησης.',
	'GROUP_OPTIONS_SAVE'			=> 'Επιλογές για όλη την ομάδα',
	'GROUP_PROMOTE'					=> 'Προαγωγή σε συντονιστή ομάδας',
	'GROUP_RANK'					=> 'Βαθμός ομάδας',
	'GROUP_RECEIVE_PM'				=> 'Η ομάδα έχει την δυνατότητα να λαμβάνει προσωπικά μηνύματα',
	...
	'GROUP_SPECIAL'					=> 'Προκαθορισμένο',
	'GROUP_TEAMPAGE'				=> 'Εμφάνιση ομάδας στην σελίδα ομάδων',
	...
	'TEAMPAGE_DISP_ALL'			=> 'Όλες οι ομάδες',
	'TEAMPAGE_DISP_DEFAULT'		=> 'Μόνο η βασική ομάδα μελών',
	'TEAMPAGE_DISP_FIRST'		=> 'Μόνο πρώτη ομάδα',
	'TEAMPAGE_EXPLAIN'			=> 'Αυτές είναι οι ομάδες οι οποίες εμφανίζονται στην σελίδα ομάδας:',
	'TEAMPAGE_FORUMS'			=> 'Εμφάνιση συντονιζόμενων Δ. Συζητήσεων',
	'TEAMPAGE_FORUMS_EXPLAIN'	=> 'Εάν οριστεί σε Ναι, οι συντονιστές θα έχουν μια λίστα με όλες τις Δ. Συζητήσεις όπου αυτοί έχουν δικαιώματα συντονιστή που εμφανίζεται στη σειρά τους. Αυτό μπορεί να είναι πολύ έντονο για την βάση δεδομένων σε μεγάλες Δ. Συζητήσεις.',
	'TEAMPAGE_MEMBERSHIPS'		=> 'Εμφάνιση μέλους ομάδες',
	'TEAMPAGE_SETTINGS'			=> 'Ρυθμίσεις σελίδας ομάδας',
	'TOTAL_MEMBERS'				=> 'Μέλη',

	'USERS_APPROVED'				=> 'Τα μέλη εγκρίθηκαν με επιτυχία.',
	'USER_DEFAULT'					=> 'Προεπιλογές μέλους',
	'USER_DEF_GROUPS'				=> 'Καθορισμένες από το μέλος ομάδες',
	'USER_DEF_GROUPS_EXPLAIN'		=> 'Αυτές είναι οι ομάδες που δημιουργούνται από εσάς ή από άλλον διαχειριστή σε αυτήν την Δ. Συζήτηση. Μπορείτε να διαχειρισθείτε τα σύνολα μελών καθώς και να επεξεργαστείτε τις ιδιότητες ομάδας ή ακόμα και να διαγράψετε την ομάδα.',
	'USER_GROUP_DEFAULT'			=> 'Ορισμός ως βασική ομάδα',
	'USER_GROUP_DEFAULT_EXPLAIN'	=> 'Λέγοντας Ναι εδώ θα ορίσετε αυτή την ομάδα ως την βασική ομάδα για τα προστιθέμενα μέλη.',
