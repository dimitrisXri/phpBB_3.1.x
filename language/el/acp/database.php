...
$lang = array_merge($lang, array(
	...
	'DELETE_SELECTED_BACKUP'	=> 'Είστε σίγουροι ότι θέλετε να διαγράψετε το επιλεγμένο αντίγραφο ασφαλείας;',
	...
	'RESTORE_SELECTED_BACKUP'	=> 'Είστε σίγουροι ότι θέλετε να επαναφέρετε το επιλεγμένο αντίγραφο ασφαλείας;',
	'RESTORE_SUCCESS'		=> 'Η επαναφορά της βάσης δεδομένων έγινε με επιτυχία.<br /><br />Η Δ. Συζήτηση σας θα πρέπει να είναι πίσω στην κατάσταση στην οποία βρισκόταν όταν δημιουργήθηκε το αντίγραφο ασφαλείας.',
