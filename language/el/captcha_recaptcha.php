...
$lang = array_merge($lang, array(
	...
	'RECAPTCHA_EXPLAIN'				=> 'Σε μια προσπάθεια για να αποτραπούν αυτοματοποιημένες υποβολές, σας ζητούμε να εισάγετε τις δύο λέξεις που εμφανίζονται στο πεδίο κειμένου παρακάτω.',
