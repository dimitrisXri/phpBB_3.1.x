...
$lang = array_merge($lang, array(
	...
	'RECAPTCHA_EXPLAIN'				=> 'Σε μια προσπάθεια για να αποτραπούν αυτοματοποιημένες υποβολές, σας ζητούμε να εισάγετε το κείμενο που εμφανίζεται, στο πεδίο κειμένου παρακάτω.',
