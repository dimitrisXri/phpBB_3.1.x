...
$lang = array_merge($lang, array(
	...
	'LOGIN_EXPLAIN_EGOSEARCH'	=> 'Η Δ. Συζήτηση απαιτεί ότι πρέπει να είστε εγγεγραμμένο μέλος και να έχετε συνδεθεί για να δείτε τις δημοσιεύσεις σας.',
	'LOGIN_EXPLAIN_UNREADSEARCH'=> 'Η Δ. Συζήτηση απαιτεί ότι πρέπει να είστε εγγεγραμμένο μέλος και να έχετε συνδεθεί για να δείτε τις μη αναγνωσμένες δημοσιεύσεις σας.',
	'LOGIN_EXPLAIN_NEWPOSTS'	=> 'Η Δ. Συζήτηση απαιτεί ότι πρέπει να είστε εγγεγραμμένο μέλος και να έχετε συνδεθεί για να δείτε νέες δημοσιεύσεις μετά την τελευταία επίσκεψή σας.',

	'MAX_NUM_SEARCH_KEYWORDS_REFINE'	=> array(
		1	=> 'Διευκρινίσατε πάρα πολλές λέξεις γι αυτήν την αναζήτηση. Παρακαλώ μην χρησιμοποιείτε πάνω από %1$d λέξη.',
		2	=> 'Διευκρινίσατε πάρα πολλές λέξεις γι αυτήν την αναζήτηση. Παρακαλώ μην χρησιμοποιείτε πάνω από %1$d λέξεις.',
	),
	...
	'PHRASE_SEARCH_DISABLED'	=> 'Αναζήτηση με βάση μια συγκεκριμένη φράση δεν υποστηρίζεται σε αυτή την Δ. Συζήτηση.',
	...
	'SEARCH_ALL_TERMS'			=> 'Αναζήτηση για όλους τους όρους ή χρήση ερωτήματος όπως εισήχθη',
	'SEARCH_ANY_TERMS'			=> 'Αναζήτηση για όλους τους όρους',
	...
	'SEARCH_FORUMS_EXPLAIN'		=> 'Επιλέξτε την Δ. Συζήτηση ή τις Δ. Συζητήσεις στις οποίες θέλετε να αναζητήσετε. Υπό-συζητήσεις θα αναζητηθούν αυτόματα εάν δεν απενεργοποιήσετε την “Αναζήτηση υπό-κατηγοριών“ παρακάτω.',
