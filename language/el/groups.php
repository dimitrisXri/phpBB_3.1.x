...
$lang = array_merge($lang, array(
	...
	'CANNOT_JOIN_GROUP'			=> 'Δεν μπορείτε να ενταχθείτε σε αυτή την ομάδα. Μπορείτε μόνο να ενταχθείτε σε ανοιχτές και ελεύθερες ομάδες.',
	'CANNOT_RESIGN_GROUP'		=> 'Δεν μπορείτε να παραιτηθείτε από αυτή την ομάδα. Μπορείτε μόνο να παραιτηθείτε από ανοιχτές και ελεύθερες ομάδες.',
	'CHANGED_DEFAULT_GROUP'		=> 'Αλλάξατε την ομάδα προεπιλογής σας με επιτυχία.',

	'GROUP_AVATAR'						=> 'Ομάδα άβαταρ',
	'GROUP_CHANGE_DEFAULT'				=> 'Είστε σίγουροι ότι θέλετε να αλλάξετε την ιδιότητα μέλους προεπιλογής σας στην ομάδα “%s”;',
	'GROUP_CLOSED'						=> 'Κλειστή',
	'GROUP_DESC'						=> 'Περιγραφή ομάδας',
	'GROUP_HIDDEN'						=> 'Κρυφή',
	'GROUP_INFORMATION'					=> 'Πληροφορίες ομάδας μελών',
	'GROUP_IS_CLOSED'					=> 'Αυτή είναι μια κλειστή ομάδα, νέα μέλη μπορούν να ενταχθούν μόνο κατόπιν πρόσκλησης ενός συντονιστή ομάδας.',
	'GROUP_IS_FREE'						=> 'Αυτή είναι μια απολύτως ανοικτή ομάδα, όλα τα νέα μέλη είναι ευπρόσδεκτα.',
	'GROUP_IS_HIDDEN'					=> 'Αυτή είναι μια κρυφή ομάδα, μόνο τα μέλη αυτής της ομάδας μπορούν να δουν τις ιδιότητες των μελών της.',
	'GROUP_IS_OPEN'						=> 'Αυτή είναι μια ανοικτή ομάδα, τα μέλη μπορούν να υποβάλουν αίτηση ένταξης.',
	'GROUP_IS_SPECIAL'					=> 'Αυτή είναι μια ειδική ομάδα, οι ειδικές ομάδες διαχειρίζονται από τους διαχειριστές της Δ. Συζήτησης.',
	'GROUP_JOIN'						=> 'Ένταξη σε ομάδα',
	'GROUP_JOIN_CONFIRM'				=> 'Είστε σίγουροι ότι θέλετε να ενταχθείτε στην επιλεγμένη ομάδα;',
	'GROUP_JOIN_PENDING'				=> 'Αίτημα για ένταξη στην ομάδα',
	'GROUP_JOIN_PENDING_CONFIRM'		=> 'Είστε σίγουροι ότι θέλετε να ζητήσετε να ενταχθείτε στην επιλεγμένη ομάδα;',
	...
	'GROUP_RESIGN_MEMBERSHIP_CONFIRM'	=> 'Είστε σίγουροι ότι θέλετε να παραιτηθείτε από την ιδιότητα μέλους σας από την επιλεγμένη ομάδα;',
	'GROUP_RESIGN_PENDING'				=> 'Παραιτηθείτε από μια εκκρεμή ιδιότητα μέλους ομάδας',
	'GROUP_RESIGN_PENDING_CONFIRM'		=> 'Είστε σίγουροι ότι θέλετε να παραιτηθείτε από την εκκρεμή ιδιότητα μέλους σας από την επιλεγμένη ομάδα;',
	...
	'USER_GROUP_DEMOTE_CONFIRM'	=> 'Είστε σίγουροι ότι θέλετε να υποβιβάσετε ως συντονιστής ομάδας από την επιλεγμένη ομάδα;',
