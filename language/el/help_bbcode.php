...
$help = array(
	...
	array(
		0 => 'Τι είναι BBCode;',
		1 => 'Ο BBCode (Bulletin Board Code) είναι μία ιδιαίτερη εφαρμογή της HTML. Είτε θέλετε στην πραγματικότητα να χρησιμοποιήσετε BBCode σε δημοσιεύσεις σας στην Δ. Συζήτηση καθορίζεται από τον διαχειριστή. Επιπλέον, μπορείτε να απενεργοποιήσετε τον BBCode σε μια ανά δημοσίευση βάση μέσω της φόρμας υποβολής. Ο BBCode είναι παρόμοιος με την σύνταξη HTML, οι εντολές της περικλείονται σε αγκύλες [ και ] αντί & lt; και & gt; και προσφέρει μεγαλύτερο έλεγχο του τι και πώς αυτό θα εμφανίζεται στην οθόνη. Ανάλογα με το πρότυπο που χρησιμοποιείτε, μπορεί να διαπιστώσετε η προσθήκη BBCode στις δημοσιεύσεις σας γίνεται πολύ ευκολότερη μέσα από ένα με δυνατότητα κλικ περιβάλλον πάνω από το πεδίο μηνύματος στη φόρμα υποβολής.',
	),
	array(
		0 => '--',
