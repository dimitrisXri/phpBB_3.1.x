...
$lang = array_merge($lang, array(
	...
	'ACCOUNT_INACTIVE'				=> 'Ο λογαριασμός σας δημιουργήθηκε. Αυτή η Δ. Συζήτηση όμως απαιτεί να τον ενεργοποιήσετε, ένας κωδικός ενεργοποίησης στάλθηκε στην διεύθυνση ηλεκτρονικού ταχυδρομείου που υποβάλλατε. Παρακαλούμε ελέγξτε την ηλεκτρονική σας αλληλογραφία για περαιτέρω πληροφορίες.',
