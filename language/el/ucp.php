...
$lang = array_merge($lang, array(
	...
	'ACCOUNT_EMAIL_CHANGED'			=> 'Ο λογαριασμός σας ενημερώθηκε. Αυτή η Δ. Συζήτηση όμως απαιτεί επανενεργοποίηση μετά από αλλαγή της ηλεκτρονικής σας διεύθυνσης αλληλογραφίας. Ένας δεσμός (κλειδί) ενεργοποίησης έχει σταλεί στην νέα ηλεκτρονική σας διεύθυνση αλληλογραφίας που υποβάλλατε. Παρακαλούμε ελέγξτε την ηλεκτρονική σας αλληλογραφία για περαιτέρω πληροφορίες.',
	'ACCOUNT_EMAIL_CHANGED_ADMIN'	=> 'Ο λογαριασμός σας ενημερώθηκε. Αυτή η Δ. Συζήτηση όμως απαιτεί επανενεργοποίηση του από κάποιον διαχειριστή μετά από αλλαγή της διεύθυνσης ηλεκτρονικού ταχυδρομείου. Ένα μήνυμα ηλεκτρονικού ταχυδρομείου έχει σταλεί σε αυτούς, και θα ενημερωθείτε όταν ενεργοποιηθεί ο λογαριασμός σας.',
	'ACCOUNT_INACTIVE'				=> 'Ο λογαριασμός σας δημιουργήθηκε. Αυτή η Δ. Συζήτηση όμως απαιτεί να τον ενεργοποιήσετε, ένας κωδικός ενεργοποίησης στάλθηκε στην διεύθυνση ηλεκτρονικού ταχυδρομείου που υποβάλατε. Παρακαλούμε ελέγξτε την ηλεκτρονική σας αλληλογραφία για περαιτέρω πληροφορίες.',
	'ACCOUNT_INACTIVE_ADMIN'		=> 'Ο λογαριασμός σας δημιουργήθηκε. Αυτή η Δ. Συζήτηση όμως απαιτεί να ενεργοποιηθεί ο λογαριασμός σας από κάποιον διαχειριστή. Ένα μήνυμα ηλεκτρονικού ταχυδρομείου έχει σταλεί σε αυτούς, και θα ενημερωθείτε όταν ενεργοποιηθεί ο λογαριασμός σας.',
	...
	'ADD_TO'						=> 'Προσθήκη [Στο]',
	'ADD_USERS_UCP_EXPLAIN'			=> 'Εδώ μπορείτε να προσθέσετε νέα μέλη στην ομάδα. Μπορείτε να επιλέξετε εάν αυτή η ομάδα γίνει η νέα προεπιλογή για τα επιλεγμένα μέλη. Παρακαλώ εισάγετε κάθε όνομα μέλους σε μια χωριστή γραμμή.',
	...
	'ATTACHMENTS_EXPLAIN'			=> 'Αυτή είναι μια λίστα των συνημμένων που έχετε δημοσιεύσει στην Δ. Συζήτηση αυτή.',
	'ATTACHMENTS_DELETED'			=> 'Τα συνημμένα διαγράφηκαν με επιτυχία.',
	'ATTACHMENT_DELETED'			=> 'Το συνημμένο διαγράφηκε με επιτυχία.',
	'AUTOLOGIN_SESSION_KEYS_DELETED'=> 'Τα επιλεγμένα κλειδιά «Απομνημόνευση κωδικού πρόσβασης» διαγράφηκαν με επιτυχία.',
	...
	'BOOKMARKS_DISABLED'		=> 'Οι σελιδοδείκτες είναι απενεργοποιημένοι σε αυτήν την Δ. Συζήτηση.',
	...
	'CONFIRM_PASSWORD_EXPLAIN'	=> 'Χρειάζεται να επιβεβαιώσετε πάλι τον κωδικό πρόσβασης σας μόνο εάν τον αλλάξατε παραπάνω.',
	...
	'COPPA_EXPLAIN'				=> 'Παρακαλώ σημειώστε ότι πατώντας υποβολή θα δημιουργήσει το λογαριασμό σας. Ωστόσο, δεν μπορεί να ενεργοποιηθεί μέχρι ο γονέας ή κηδεμόνας να εγκρίνει την εγγραφή σας. Θα σας αποσταλεί μέσω ηλεκτρονικού ταχυδρομείου ένα αντίγραφο από την απαραίτητη φόρμα με τα στοιχεία για το πού να την αποστείλετε.',
	...
	'CURRENT_CHANGE_PASSWORD_EXPLAIN' => 'Για να αλλάξετε τον κωδικό, την διεύθυνση ηλεκτρονικού ταχυδρομείου σας, ή το όνομα μέλους, πρέπει να αλλάξετε τον τρέχοντα κωδικό.',
	...
	'DELETE_ATTACHMENT_CONFIRM'	=> 'Είστε σίγουροι ότι επιθυμείτε να διαγράψετε αυτό το συνημμένο;',
	'DELETE_ATTACHMENTS_CONFIRM'=> 'Είστε σίγουροι ότι επιθυμείτε να διαγράψετε αυτά τα συνημμένα;',
	'DELETE_AVATAR'				=> 'Διαγραφή εικόνας',
	'DELETE_COOKIES_CONFIRM'	=> 'Είστε σίγουροι ότι επιθυμείτε να διαγράψετε όλα τα cookies από αυτήν την Δ Συζήτηση;',
	'DELETE_MARKED_PM'			=> 'Διαγραφή επιλεγμένων μηνυμάτων',
	'DELETE_MARKED_PM_CONFIRM'	=> 'Είστε σίγουροι ότι επιθυμείτε να διαγράψετε όλα τα επιλεγμένα μηνύματα;',
	'DELETE_OLDEST_MESSAGES'	=> 'Διαγραφή παλαιότερων μηνυμάτων',
	'DELETE_MESSAGE'			=> 'Διαγραφή μηνύματος',
	'DELETE_MESSAGE_CONFIRM'	=> 'Είστε σίγουροι ότι επιθυμείτε να διαγράψετε αυτό το προσωπικό μήνυμα;',
	'DELETE_MESSAGES_IN_FOLDER'	=> 'Διαγραφή όλων των μηνυμάτων μέσα στον αφαιρούμενο φάκελο',
	'DELETE_RULE'				=> 'Διαγραφή κανόνα',
	'DELETE_RULE_CONFIRM'		=> 'Είστε σίγουροι ότι επιθυμείτε να διαγράψετε αυτόν τον κανόνα;',
	...
	'EMAIL_REMIND'				=> 'Αυτή πρέπει να είναι η διεύθυνση ηλεκτρονικού ταχυδρομείου που σχετίζεται με το λογαριασμό σας. Εάν δεν την έχετε αλλάξει αυτή μέσω του Πίνακα Ελέγχου Μέλους τότε αυτή είναι η διεύθυνση ηλεκτρονικού ταχυδρομείου που καταχωρήσατε με τον λογαριασμό σας',
	...
	'FIELD_INVALID_CHARS_LETTER_NUM_UNDERSCORE'		=> 'Το πεδίο “%s” περιέχει μη επιτρεπτούς χαρακτήρες, επιτρέπονται μόνο γράμματα, αριθμητικοί ή _ χαρακτήρες.',
	'FIELD_INVALID_DATE'				=> 'Το πεδίο “%s” περιέχει μια άκυρηή ημερομηνία.',
	...
	'FOES_EXPLAIN'				=> 'Οι εχθροί είναι μέλη τα οποία αγνοούνται εξ ορισμού. Δημοσιεύσεις από αυτά τα μέλη δεν θα είναι εξ ολοκλήρου ορατές. Τα προσωπικά μηνύματα από εχθρούς εξακολουθούν να επιτρέπονται. Σημειώστε ότι δεν μπορείτε να αγνοήσετε συντονιστές ή διαχειριστές.',
	...
	'FORCE_PASSWORD_EXPLAIN'	=> 'Προκειμένου να μπορέσετε να συνεχίσετε την περιήγηση στην Δ. Συζήτηση σας ζητείται να αλλάξετε τον κωδικό πρόσβασής σας.',
	...
	'GRAVATAR_AVATAR_EMAIL_EXPLAIN'	=> 'Εισάγετε τη διεύθυνση ηλεκτρονικού ταχυδρομείου που χρησιμοποιήσατε για την εγγραφή σας στο λογαριασμό <a href="http://www.gravatar.com/">Gravatar</a>.',
	...
	'HIDE_ONLINE_EXPLAIN'		=> 'Η αλλαγή αυτής της ρύθμισης δεν θα τεθεί σε ισχύ μέχρι την επόμενη επίσκεψή σας στην Δ. Συζήτηση.',
	...
	'LOGIN_LINK'					=> 'Σύνδεσμος ή δημιουργία λογαριασμού σας σε μια εξωτερική υπηρεσία με το λογαριασμό της Δ. Συζήτησής σας',
	'LOGIN_LINK_EXPLAIN'			=> 'Έχετε προσπαθήσει να συνδεθεί με μια εξωτερική υπηρεσία η οποία δεν έχει ακόμα συνδεθεί σε ένα λογαριασμό σε αυτό το σύστημα. Θα πρέπει να γνωρίζετε είτε να συνδέσετε αυτόν το λογαριασμό σε έναν υπάρχοντα λογαριασμό ή να δημιουργήσετε ένα νέο λογαριασμό.',
	...
	'LOGIN_LINK_NO_DATA_PROVIDED'	=> 'Δεν έχουν παρασχεθεί δεδομένα σε αυτή τη σελίδα για να συνδέσετε ένα εξωτερικό λογαριασμό σε λογαριασμό Δ. Συζήτησης. Παρακαλούμε επικοινωνήστε με τον διαχειριστή του συστήματος εάν συνεχίσετε να αντιμετωπίζετε προβλήματα.',
	'LOGIN_KEY'					=> 'Σύνδεσης κλειδί',
	'LOGIN_TIME'				=> 'Σύνδεσης χρόνος',
	'LOGIN_REDIRECT'			=> 'Έχετε συνδεθεί με επιτυχία.',
	'LOGOUT_FAILED'				=> 'Δεν έχετε αποσυνδεθεί, ωστόσο το αίτημα δεν ταιριάζει στην σύνοδο σας. Παρακαλώ επικοινωνήστε με τον διαχειριστή της Δ. Συζήτησης εάν συνεχίσετε να αντιμετωπίζετε προβλήματα.',
	...
	'MAX_FOLDER_REACHED'			=> 'Ό μέγιστος επιτρεπόμενος αριθμός φακέλων που καθορίζονται από μέλος επιτευχθηκε',
	...
	'MOVE_PM_ERROR'					=> array(
		1	=> 'Ένα σφάλμα σημειώθηκε κατά την μεταφορά των μηνυμάτων στον νέο φάκελο, μόνο %2$d από %1$s μετακινήθηκαν.',
		2	=> 'Ένα σφάλμα σημειώθηκε κατά την μεταφορά των μηνυμάτων σε νέο φάκελο, μόνο %2$d από %1$s μηνύματα μετακινήθηκαν.',
	),
	...
	'NOTIFICATIONS_MARK_ALL_READ'						=> 'Σημειώστε όλες τις ειδοποιήσεις ως αναγνωσμένες',
	...
	'NOTIFICATION_TYPE'									=> 'Ειδοποίησης τύπος',
	...
	'NOTIFY_METHOD_EXPLAIN'			=> 'Μέθοδος για αποστολή μηνυμάτων δια μέσου της Δ. Συζήτησης.',
	'NOTIFY_METHOD_IM'				=> 'Μόνο μέσω Jabber',
	'NOTIFY_ON_PM'					=> 'Να ενημερώνομαι για νέα προσωπικά μηνύματα',
	'NOT_ADDED_FRIENDS_ANONYMOUS'	=> 'Δεν μπορείτε να προσθέσετε το μέλος επισκέπτης (anonymous) στην λίστα φίλων σας.',
	'NOT_ADDED_FRIENDS_BOTS'		=> 'Δεν μπορείτε να προσθέσετε bots στην λίστα των φίλων σας.',
	'NOT_ADDED_FRIENDS_FOES'		=> 'Δεν μπορείτε να προσθέσετε στην λίστα φίλων σας μέλη που βρίσκονται στη λίστα εχθρών σας.',
	'NOT_ADDED_FRIENDS_SELF'		=> 'Δεν μπορείτε να προσθέσετε τον εαυτό σας στην λίστα φίλων σας.',
	'NOT_ADDED_FOES_MOD_ADMIN'		=> 'Δεν μπορείτε να προσθέσετε διαχειριστές και συντονιστές στην λίστα εχθρών σας.',
	'NOT_ADDED_FOES_ANONYMOUS'		=> 'Δεν μπορείτε να προσθέσετε το μέλος επισκέπτης (anonymous) στην λίστα εχθρών σας.',
	'NOT_ADDED_FOES_BOTS'			=> 'Δεν μπορείτε να προσθέσετε bots στην λίστα εχθρών σας.',
	'NOT_ADDED_FOES_FRIENDS'		=> 'Δεν μπορείτε να προσθέσετε στην λίστα εχθρών σας μέλη που βρίσκονται στη λίστα φίλων σας.',
	...
	'NO_FOES'					=> 'Δεν έχουν καθοριστεί εχθροί επί του παρόντος',
	'NO_FRIENDS'				=> 'Δεν έχουν καθοριστεί φίλοι επί του παρόντος',
	...
	'PERMISSIONS_TRANSFERRED'	=> 'Οι προσβάσεις από τον/την <strong>%s</strong> μεταφέρθηκαν με επιτυχία, μπορείτε τώρα να περιηγηθείτε στην Δ. Συζήτηση με τα δικαιώματα αυτού του μέλους.<br />Σημειώστε ότι δικαιώματα διαχειριστή δεν είναι δυνατόν να μεταφερθούν. Μπορείτε να ανακαλέσετε αυτήν την ενέργεια οποιαδήποτε στιγμή.',
	'PM_DISABLED'				=> 'Τα προσωπικά μηνύματα έχουν απενεργοποιηθεί σε αυτήν την Δ. Συζήτηση.',
	'PM_FROM'					=> 'Από',
	...
	'PROFILE_AUTOLOGIN_KEYS'	=> 'Το "Απομνημόνευση κωδικού πρόσβασης" σας συνδέει αυτόματα όταν επισκέπτεστε την ιστοσελίδα. Αν αποσυνδεθείτε, το κλειδί σύνδεσης διαγράφεται μόνο στον υπολογιστή που χρησιμοποιείτε για να αποσυνδεθείτε. Εδώ μπορείτε να δείτε τα κλειδιά σύνδεσης που δημιουργούνται σε άλλους υπολογιστές και χρησιμοποιούνται για την πρόσβαση σε αυτήν την ιστοσελίδα.',
	'PROFILE_NO_AUTOLOGIN_KEYS'	=> 'Δεν υπάρχουν "Απομνημόνευση κωδικού" πρόσβασης κλειδιά.',

	'RECIPIENT'							=> 'Παραλήπτης',
	'RECIPIENTS'						=> 'Παραλήπτες',
	'REGISTRATION'						=> 'Εγγραφή',
	'RELEASE_MESSAGES'					=> '%sαπελευθέρωση όλων των μηνυμάτων σε αναμονή%s… θα ταξινομηθούν πάλι στους κατάλληλους φακέλους αν υπάρχει διαθέσιμος χώρος.',
	'REMOVE_ADDRESS'					=> 'Διαγραφή διεύθυνσης',
	'REMOVE_SELECTED_BOOKMARKS'			=> 'Αφαίρεση επιλεγμένων σελιδοδεικτών',
	'REMOVE_SELECTED_BOOKMARKS_CONFIRM'	=> 'Είστε σίγουροι ότι θέλετε να αφαιρέσετε όλους τους επιλεγμένους σελιδοδείκτες;',
	'REMOVE_BOOKMARK_MARKED'			=> 'Αφαίρεση σημειωμένων σελιδοδεικτών',
	'REMOVE_FOLDER'						=> 'Διαγραφή φακέλου',
	'REMOVE_FOLDER_CONFIRM'				=> 'Είστε σίγουροι ότι θέλετε να διαγράψετε αυτόν τον φάκελο;',
	'RENAME'							=> 'Μετονομασία',
	...
	'SIGNATURE_EXPLAIN'			=> 'Αυτό είναι ένα κείμενο που μπορεί να προστίθεται στις δημοσιεύσει σας. Υπάρχει ένα όριο %d χαρακτήρων.',
	...
	'UCP_ADMIN_ACTIVATE'		=> 'Σημειώστε ότι πρέπει να εισάγετε μια έγκυρη διεύθυνση ηλεκτρονικού ταχυδρομείου πριν ενεργοποιηθεί ο λογαριασμός σας. Ο διαχειριστής θα ελέγξει τον λογαριασμό σας και εάν εγκριθεί θα σας αποσταλεί μήνυμα ηλεκτρονικού ταχυδρομείου στην διεύθυνση που έχετε ορίσει.',
	'UCP_ATTACHMENTS'			=> 'Συνημμένα',
	'UCP_AUTH_LINK'				=> 'Εξωτερικοί λογαριασμοί',
	'UCP_AUTH_LINK_ASK'			=> 'Προς το παρόν δεν έχετε λογαριασμό που συνδέεται με αυτήν την εξωτερική υπηρεσία. Πατήστε στο κουμπί παρακάτω για να συνδέσετε τον λογαριασμό της Δ. Συζήτησης σας με αυτήν την εξωτερική υπηρεσία.',
	...
	'UCP_AUTH_LINK_NOT_SUPPORTED'	=> 'Η σύνδεση λογαριασμών της Δ. Συζήτησης σε εξωτερικές υπηρεσίες δεν υποστηρίζεται από την τρέχουσα μέθοδο ελέγχου ταυτότητας αυτής της Δ. Συζήτησης.',
	...
	'UCP_EMAIL_ACTIVATE'		=> 'Σημειώστε ότι πρέπει να εισάγετε μια έγκυρη διεύθυνση ηλεκτρονικού ταχυδρομείου πριν ενεργοποιηθεί ο λογαριασμός σας. Θα λάβετε ένα μήνυμα ηλεκτρονικού ταχυδρομείου στην διεύθυνση που έχετε ορίσει που θα περιέχει έναν σύνδεσμο ενεργοποίησης του λογαριασμού.',
	...
	'UCP_NOTIFICATION_OPTIONS_EXPLAIN'	=> 'Εδώ μπορείτε να ρυθμίσετε τις προτιμώμενες μεθόδους ειδοποίησης για την Δ. Συζήτηση.',
	...
	'UCP_PROFILE_AUTOLOGIN_KEYS'=> 'Διαχείριση “Απομνημόνευση κωδικού πρόσβασης” κλειδιών',
	...
	'WATCHED_EXPLAIN'			=> 'Παρακάτω εμφανίζεται μια λίστα των Δ. Συζητήσεων και των θεμάτων που παρακολουθείτε. Θα ενημερωθείτε όταν υπάρξουν νέες δημοσιεύσεις και στα δύο. Για μη παρακολούθηση κάποιου επιλέξτε την Δ. συζήτηση ή το θέμα και πατήστε στο <em>Παύση παρακολούθησης σημειωμένων</em>.',
