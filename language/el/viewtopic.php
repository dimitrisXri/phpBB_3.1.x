...
$lang = array_merge($lang, array(
	...
	'LOGIN_VIEWTOPIC'		=> 'Η Δ. Συζήτηση απαιτεί ότι πρέπει να είστε εγγεγραμμένο μέλος και να έχετε συνδεθεί για να δείτε αυτό το θέμα.',
	...
	'NO_NEWER_TOPICS'		=> 'Δεν υπάρχουν νεώτερα θέματα σε αυτή την Δ. Συζήτηση.',
	'NO_OLDER_TOPICS'		=> 'Δεν υπάρχουν παλαιότερα θέματα σε αυτή την Δ. Συζήτηση.',
	...
	'RETURN_POST'			=> '%sΠατήστε εδώ για να επιστρέψετε στην δημοσίευση%s',
